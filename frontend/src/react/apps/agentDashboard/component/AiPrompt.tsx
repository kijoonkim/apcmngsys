  ...
  return (
    <div className="bg-gray-100 min-h-screen p-8 font-sans">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="mb-6">
          <label htmlFor="api-key" className="block text-lg font-semibold mb-2">
            API 키 입력
          </label>
          <input
            type="password"
        ...
        <div className="mb-6">
          <label htmlFor="context-data" className="block text-lg font-semibold mb-2">
            1. 기초 데이터 (Context) 입력
          </label>
          <p className="text-sm text-gray-600 mb-2">
            분석할 데이터를 여기에 텍스트 형태로 붙여넣으세요. (예: 엑셀 데이터 복사)
          </p>
          <textarea
            id="context-data"
            rows="10"
        ...
        <div className="mb-6">
          <label htmlFor="user-question" className="block text-lg font-semibold mb-2">
            2. 질문 입력
          </label>
          <textarea
            id="user-question"
