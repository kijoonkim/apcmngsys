...
const ApcItem = () => {
    ...
    return (
        <div
            ref={tableScrollRef} // 👈 1. ref를 내부 div가 아닌 루트 div로 이동
            className="p-6 bg-gray-50 font-pretard hide-scrollbar" // 👈 4. hide-scrollbar 추가
            style={{ height: '100%', overflowY: 'auto' }} // 👈 2. 높이를 100% 채우고, 세로 스크롤 적용
        >
