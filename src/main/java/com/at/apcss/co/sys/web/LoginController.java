					...
					if (!ComConstants.CON_USER_STTS_VALID.equals(userStts)) {
						...
						if (isDuplicateUser) {
							...
							*/
							...
							request.getSession().setAttribute("linkRviewUrl", getLinkRviewUrl());
							System.out.println("aaaaa@@@@@@@@@@@@");
							System.out.println(getLinkRviewUrl());
...
//				comLogService.insertMenuHstry(comLogVo);
	...
	private void setLoginInfo(LoginVO resultVO, HttpServletRequest request) {
