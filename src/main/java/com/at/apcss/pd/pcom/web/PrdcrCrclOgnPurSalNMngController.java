...
@Controller
public class PrdcrCrclOgnPurSalNMngController extends BaseController{
	...
	@RequestMapping(value = "pd/pcom/PrdcrCrclOgnPurSalNMng.do")
	public String PrdcrCrclOgnPurSalNMng() {
		return "apcss/pd/pcom/PrdcrCrclOgnPurSalNMng";
	}
