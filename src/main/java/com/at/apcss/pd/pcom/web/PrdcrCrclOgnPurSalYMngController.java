...
@Controller
public class PrdcrCrclOgnPurSalYMngController extends BaseController{
	...
	@RequestMapping(value = "pd/pcom/PrdcrCrclOgnPurSalYMng.do")
	public String PrdcrCrclOgnPurSalYMng() {
		return "apcss/pd/pcom/PrdcrCrclOgnPurSalYMng";
	}
