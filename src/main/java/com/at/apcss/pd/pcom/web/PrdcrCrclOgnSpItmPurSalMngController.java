...
@Controller
public class PrdcrCrclOgnSpItmPurSalMngController extends BaseController{
	...
	@RequestMapping(value = "pd/pcom/PrdcrCrclOgnSpItmPurSalMng.do")
	public String PrdcrCrclOgnSpItmPurSalMng() {
		return "apcss/pd/pcom/PrdcrCrclOgnSpItmPurSalMng";
	}
