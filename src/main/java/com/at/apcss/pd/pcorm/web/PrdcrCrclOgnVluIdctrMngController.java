...
public class PrdcrCrclOgnVluIdctrMngController extends BaseController{
	...
	public ResponseEntity<HashMap<String, Object>> selectScrUserGrid01(Model model, @RequestBody PrdcrCrclOgnVluIdctrMngVO prdcrCrclOgnVluIdctrMngVO, HttpServletRequest request) throws Exception{
		HashMap<String,Object> resultMap = new HashMap<String,Object>();
		List<PrdcrCrclOgnVluIdctrMngVO> resultList = new ArrayList<>();
		try {
			 resultList = prdcrCrclOgnVluIdctrMngService.selectScrUserGrid01(prdcrCrclOgnVluIdctrMngVO);
		} catch (Exception e) {
			logger.debug(e.getMessage());
			return getErrorResponseEntity(e);
		}
	...
	public ResponseEntity<HashMap<String, Object>> selectScrUserGrid02(Model model, @RequestBody PrdcrCrclOgnVluIdctrMngVO prdcrCrclOgnVluIdctrMngVO, HttpServletRequest request) throws Exception{
		HashMap<String,Object> resultMap = new HashMap<String,Object>();
		List<PrdcrCrclOgnVluIdctrMngVO> resultList = new ArrayList<>();
		try {
			 resultList = prdcrCrclOgnVluIdctrMngService.selectScrUserGrid02(prdcrCrclOgnVluIdctrMngVO);
		} catch (Exception e) {
			logger.debug(e.getMessage());
			return getErrorResponseEntity(e);
		}
	...
	public ResponseEntity<HashMap<String, Object>> selectScrUserGrid03(Model model, @RequestBody PrdcrCrclOgnVluIdctrMngVO prdcrCrclOgnVluIdctrMngVO, HttpServletRequest request) throws Exception{
		HashMap<String,Object> resultMap = new HashMap<String,Object>();
		List<PrdcrCrclOgnVluIdctrMngVO> resultList = new ArrayList<>();
		try {
			 resultList = prdcrCrclOgnVluIdctrMngService.selectScrUserGrid03(prdcrCrclOgnVluIdctrMngVO);
		} catch (Exception e) {
			logger.debug(e.getMessage());
			return getErrorResponseEntity(e);
		}
	...
	public ResponseEntity<HashMap<String, Object>> selectScrUserGrid04(Model model, @RequestBody PrdcrCrclOgnVluIdctrMngVO prdcrCrclOgnVluIdctrMngVO, HttpServletRequest request) throws Exception{
		HashMap<String,Object> resultMap = new HashMap<String,Object>();
		List<PrdcrCrclOgnVluIdctrMngVO> resultList = new ArrayList<>();
		try {
			 resultList = prdcrCrclOgnVluIdctrMngService.selectScrUserGrid04(prdcrCrclOgnVluIdctrMngVO);
		} catch (Exception e) {
			logger.debug(e.getMessage());
			return getErrorResponseEntity(e);
		}
	...
	public ResponseEntity<HashMap<String, Object>> selectScrUserGrid05(Model model, @RequestBody PrdcrCrclOgnVluIdctrMngVO prdcrCrclOgnVluIdctrMngVO, HttpServletRequest request) throws Exception{
		HashMap<String,Object> resultMap = new HashMap<String,Object>();
		List<PrdcrCrclOgnVluIdctrMngVO> resultList = new ArrayList<>();
		try {
			 resultList = prdcrCrclOgnVluIdctrMngService.selectScrUserGrid05(prdcrCrclOgnVluIdctrMngVO);
		} catch (Exception e) {
			logger.debug(e.getMessage());
			return getErrorResponseEntity(e);
		}
