...
public class PrdcrOgnGenalTblMngController extends BaseController{
	...
	// 생산자조직 총괄표 로우데이터
	@PostMapping(value = "/pd/pom/selectRawDataPrdcrOgnzList.do", consumes = {MediaType.APPLICATION_JSON_VALUE , MediaType.TEXT_HTML_VALUE})
	public ResponseEntity<HashMap<String, Object>> selectRawDataPrdcrOgnzList(Model model, @RequestBody PrdcrOgnGenalTblMngVO PrdcrOgnGenalTblMngVO, HttpServletRequest request) throws Exception{
		HashMap<String,Object> resultMap = new HashMap<String,Object>();
		List<PrdcrOgnGenalTblMngVO> resultList = new ArrayList<>();
		try {
