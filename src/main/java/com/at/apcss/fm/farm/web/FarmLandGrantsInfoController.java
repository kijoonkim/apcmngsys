			...
			try {
				...
				for (int k = 0; k < nList.getLength(); k++) {
	                ...
	                if (node.getNodeType() == Node.ELEMENT_NODE) {
	                    ...
	                    String pnuCode = getValue("pnuCode", element);
	                    String bsnsBgnde = getValue("bsnsBgnde", element);
	                    String bsnsEndde = getValue("bsnsEndde", element);
	                    String bsnsCode = getValue("bsnsCode", element);
	                    String bsnsNm = getValue("bsnsNm", element);
	                    String sttus = getValue("sttus", element);
	                    String applcntNm = getValue("applcntNm", element);
	                    String ldgrfl = getValue("ldgrfl", element);
	                    String frlndAdres = getValue("frlndAdres", element);
	                    String legaldongCode = getValue("legaldongCode", element);
	                    String mnnm = getValue("mnnm", element);
	                    String slno = getValue("farmngBeginStleCdNm", element);
	                    String reqstAr = getValue("reqstAr", element);
	                    String delYn = getValue("delYn", element);
	                    farmLandGrantsInfoVO.setFrmerSn(frmerSn);
	                    farmLandGrantsInfoVO.setPnuCode(pnuCode);
	                    farmLandGrantsInfoVO.setBsnsBgnde(bsnsBgnde);
	                    farmLandGrantsInfoVO.setBsnsEndde(bsnsEndde);
	                    farmLandGrantsInfoVO.setBsnsCode(bsnsCode);
	                    farmLandGrantsInfoVO.setBsnsNm(bsnsNm);
	                    farmLandGrantsInfoVO.setSttus(sttus);
	                    farmLandGrantsInfoVO.setApplcntNm(applcntNm);
	                    farmLandGrantsInfoVO.setLdgrfl(ldgrfl);
	                    farmLandGrantsInfoVO.setFrlndAdres(frlndAdres);
	                    farmLandGrantsInfoVO.setLegaldongCode(legaldongCode);
	                    farmLandGrantsInfoVO.setMnnm(mnnm);
	                    farmLandGrantsInfoVO.setSlno(slno);
	                    farmLandGrantsInfoVO.setReqstAr(reqstAr);
	                    farmLandGrantsInfoVO.setDelYn(delYn);
	                    farmLandGrantsInfoVO.setSysFrstInptPrgrmId(getPrgrmId());
						farmLandGrantsInfoVO.setSysFrstInptUserId(getUserId());
						farmLandGrantsInfoVO.setSysLastChgPrgrmId(getPrgrmId());
						farmLandGrantsInfoVO.setSysLastChgUserId(getUserId());
