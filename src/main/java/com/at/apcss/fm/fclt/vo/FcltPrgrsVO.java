...
public class FcltPrgrsVO extends ComVO{
	...
	private String ctpvPicNm;		//시도 담당자명
	private String ctpvCoTelno;		//시도 담당자 회사번호
	private String ctpvMblTelno;	//시도 담당자 휴대폰 번호
	private String sggPicNm;		//시군구 담당자명
	private String sggCoTelno;		//시군구 담당자 회사번호
	private String sggMblTelno;		//시군구 담당자 휴대폰 번호
