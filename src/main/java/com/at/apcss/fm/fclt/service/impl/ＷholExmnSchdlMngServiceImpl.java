...
import com.apcmngsys.apcss.fm.fclt.mapper.ＷholExmnSchdlMngMapper;
import com.apcmngsys.apcss.fm.fclt.service.ＷholExmnSchdlMngService;
import com.apcmngsys.apcss.fm.fclt.vo.ＷholExmnSchdlMngVO;


/**
 * @Class Name : ＷholExmnSchdlMngServiceImpl.java
 * @Description : 전수조사일정관리 서비스를 정의하기 위한 서비스 구현 클래스
 * @author 정연두
 * @since 2023.06.21
 * @version 1.0
 * @see
