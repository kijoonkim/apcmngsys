...
import com.apcmngsys.apcss.fm.fclt.mapper.FcltOperHfInfoMapper;
import com.apcmngsys.apcss.fm.fclt.mapper.FcltPrgrsMapper;
import com.apcmngsys.apcss.fm.fclt.service.FcltOperHfInfoService;
...
public class FcltOperHfInfoServiceImpl extends BaseServiceImpl implements FcltOperHfInfoService{
	...
	public int insertFcltOperHfInfo(FcltOperHfInfoVO fcltOperHfInfoVO) throws Exception {
		...
		String prgrsYn = fcltOperHfInfoVO.getPrgrsYn() == null ? "N" : fcltOperHfInfoVO.getPrgrsYn();
		...
		if(insertedCnt == 1 && prgrsYn.equals("Y")) {
			...
			fcltPrgrsVO.setPrgrsSel("8");
			//임시저장
			String tmprStrgYn = fcltOperHfInfoVO.getTmprStrgYn() == null ? "N" : fcltOperHfInfoVO.getTmprStrgYn();
