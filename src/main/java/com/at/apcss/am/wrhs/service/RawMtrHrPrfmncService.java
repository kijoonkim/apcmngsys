 ...
 * </pre>
 */
public interface RawMtrHrPrfmncService {
	...
	/**
	 * 원물입고시간실적 저장
	 * @param rawMtrHrPrfmncList
	 * @return
	 * @throws Exception
	 */
	public HashMap<String, Object> multiSaveRawMtrHrPrfmncList(List<RawMtrHrPrfmncComVO> rawMtrHrPrfmncList) throws Exception;
