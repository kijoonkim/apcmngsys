...
public class PltBxApiController extends BaseController{
	...
	@PostMapping(value = "/am/cmns/selectPltBxList", consumes = {MediaType.APPLICATION_JSON_VALUE , MediaType.TEXT_HTML_VALUE})
	...
	// APC 환경설정 - 팔레트/박스 등록
	@PostMapping(value = "/am/cmns/insertPltBxList", consumes = {MediaType.APPLICATION_JSON_VALUE , MediaType.TEXT_HTML_VALUE})
	...
	// APC 환경설정 - 팔레트/박스 등록
	@PostMapping(value = "/am/cmns/updatePltBxList", consumes = {MediaType.APPLICATION_JSON_VALUE , MediaType.TEXT_HTML_VALUE})
	...
	// APC 환경설정 - 팔레트/박스 등록
	@PostMapping(value = "/am/cmns/deletePltBx", consumes = {MediaType.APPLICATION_JSON_VALUE , MediaType.TEXT_HTML_VALUE})
