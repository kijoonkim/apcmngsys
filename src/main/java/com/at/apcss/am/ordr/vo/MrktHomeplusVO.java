...
@Getter
@Setter
public class MrktHomeplusVO extends ComVO {
	...
	private List<MrktHomeplusDtlVO> dtlList;

	public List<MrktHomeplusDtlVO> getDtlList() {
		return dtlList == null ? null : dtlList.stream().collect(Collectors.toList());
	}

	public void setDtlList(List<MrktHomeplusDtlVO> dtlList) {
