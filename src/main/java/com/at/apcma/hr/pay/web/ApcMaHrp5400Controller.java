 ...
 *
 * <pre>
 * << 고용보험 내역 관리 정보(Modification Information) >>
 *
 *  수정일      수정자		수정내용
 *  ----------	----------	---------------------------
 *  2023.07.03  표주완     	최초 생성
 *
 *  </pre>
 */
@Controller
public class ApcMaHrp5400Controller extends BaseController {
    ...
    public ResponseEntity<HashMap<String, Object>> selectHrp5400List(
        ...
        logger.info("=============selectHrp5400List=====start========");
        HashMap<String,Object> resultMap = new HashMap<String,Object>();

        try {

            param.put("procedure", "SP_HRW5400_Q");
    ...
    public ResponseEntity<HashMap<String, Object>> insertHrp5400S1(
        ...
        logger.info("=============insertHrp5400S1=====start========");
        HashMap<String,Object> resultMap = new HashMap<String,Object>();

        try {

            param.put("procedure", "SP_HRW5400_S1");
            resultMap = apcMaCommDirectService.callProc(param, session, request, "");
    ...
    public ResponseEntity<HashMap<String, Object>> insertHrp5400S(
        ...
        logger.info("=============insertHrp5400S=====start========");
        HashMap<String,Object> resultMap = new HashMap<String,Object>();

        try {

            param.put("procedure", "SP_HRW5400_S");
            resultMap = apcMaCommDirectService.callProc(param, session, request, "");
