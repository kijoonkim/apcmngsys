...
public class ApcMaFbs2310Controller extends BaseController {
    ...
    public ResponseEntity<HashMap<String, Object>> selectFbs2310List(
        ...
        try {
            param.put("procedure", 		"P_FBS2310_Q");
    ...
    public ResponseEntity<HashMap<String, Object>> insertFbs2310List(
        ...
        try {
            resultMap = apcMaComService.processForListData(param, session, request, "", "P_FBS2310_S");
    ...
    public ResponseEntity<HashMap<String, Object>> insertFbs2310Sub(
        ...
        try {
            resultMap = apcMaComService.processForListData(param, session, request, "", "P_FBS2310_S1");
    ...
    public ResponseEntity<HashMap<String, Object>> insertFim5300AccountInfo(
        ...
        try {
            param.put("procedure", 		"P_FIM5300_S2");
            resultMap = apcMaCommDirectService.callProc(param, session, request, "");
        } catch (Exception e) {
            e.printStackTrace();
            logger.debug(e.getMessage());
    ...
    public ResponseEntity<HashMap<String, Object>> insertFim5300BalanceInfo(
        ...
        try {
            param.put("procedure", 		"P_FIM5300_S3");
            resultMap = apcMaCommDirectService.callProc(param, session, request, "");
        } catch (Exception e) {
            e.printStackTrace();
            logger.debug(e.getMessage());
    ...
    public ResponseEntity<HashMap<String, Object>> selectFbsReqMissNumList(
        ...
        try {
            param.put("procedure", 		"P_FBSREQMISSNUM_Q");
            resultMap = apcMaCommDirectService.callProc(param, session, request, "");
        } catch (Exception e) {
            e.printStackTrace();
            logger.debug(e.getMessage());
    ...
    @PostMapping(value = "/fi/ftr/trn/selectFbsOpenList.do", consumes = {MediaType.APPLICATION_JSON_VALUE , MediaType.TEXT_HTML_VALUE})
    ...
    public ResponseEntity<HashMap<String, Object>> selectFbsBalanceList(
        ...
        try {
            param.put("procedure", 		"P_FBSBALANCE_Q");
            resultMap = apcMaCommDirectService.callProc(param, session, request, "");
        } catch (Exception e) {
            e.printStackTrace();
            logger.debug(e.getMessage());
