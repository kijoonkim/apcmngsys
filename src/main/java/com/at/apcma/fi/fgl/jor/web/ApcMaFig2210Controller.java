...
public class ApcMaFig2210Controller extends BaseController {
    ...
    public ResponseEntity<HashMap<String, Object>> selectFig2210QList(
    	...
    	try {
    		...
    		param.put("procedure", 		"SP_FIG2210_Q");
    ...
    public ResponseEntity<HashMap<String, Object>> selectFig2210ItemQList(
    	...
    	try {
    		...
    		param.put("procedure", 		"SP_FIG2210_ITEM_Q");
    		resultMap = apcMaCommDirectService.callProc(param, session, request, "");
    ...
    public ResponseEntity<HashMap<String, Object>> insertFig2210S(
    	...
    	try {
    		...
    		param.put("procedure", 		"SP_FIG2210_S");
    		resultMap = apcMaCommDirectService.callProc(param, session, request, "");
    ...
    public ResponseEntity<HashMap<String, Object>> updateFig2210S2(
    	...
    	try {
    		...
    		param.put("procedure", 		"SP_FIG2210_S2");
    		resultMap = apcMaCommDirectService.callProc(param, session, request, "");
    ...
    // 보류해제, 보류지정 처리
    @PostMapping(value = "/fi/fgl/jor/updateFig2210S1.do", consumes = {MediaType.APPLICATION_JSON_VALUE , MediaType.TEXT_HTML_VALUE})
    public ResponseEntity<HashMap<String, Object>> updateFig2210S1(
    		@RequestBody Map<String, Object> param
    		, Model model
    		, HttpSession session
    		, HttpServletRequest request) throws Exception{
    	
    	logger.info("=============updateFig2210S1=====start========");
    	HashMap<String,Object> resultMap = new HashMap<String,Object>();
    	...
    	logger.info("=============updateFig2210S1=====end========");
    	return getSuccessResponseEntityMa(resultMap);
    }   
