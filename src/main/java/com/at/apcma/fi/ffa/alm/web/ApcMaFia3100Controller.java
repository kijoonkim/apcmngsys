...
public class ApcMaFia3100Controller extends BaseController {
	...
	// 자산원장 조회
	@PostMapping(value = "/fi/ffa/com/selectFia3100List.do", consumes = {MediaType.APPLICATION_JSON_VALUE , MediaType.TEXT_HTML_VALUE})
	...
	// 자산원장 신규
    @PostMapping(value = "/fi/fgl/com/saveFia3100List.do", consumes = {MediaType.APPLICATION_JSON_VALUE , MediaType.TEXT_HTML_VALUE})
