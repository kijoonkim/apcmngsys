package com.apcmngsys.apcma.fi.ffa.alm.web;
 ...
 *
 * <pre>
 * << 이동내역등록(Modification Information) >>
 *
 *  수정일      수정자		수정내용
 *  ----------	----------	---------------------------
 ...
 */
@Controller
public class ApcMaFia4100Controller extends BaseController {
	...
	// 이동내역등록 조회
	@PostMapping(value = "/fi/ffa/alm/selectFia4100List.do", consumes = {MediaType.APPLICATION_JSON_VALUE , MediaType.TEXT_HTML_VALUE})
	public ResponseEntity<HashMap<String, Object>> selectFia4100List(
    		@RequestBody Map<String, Object> param
			,Model model
			,HttpSession session
			,HttpServletRequest request) throws Exception{

		logger.info("=============selectFia4100List=====start========");
		HashMap<String,Object> resultMap = new HashMap<String,Object>();

		try {
			
			param.put("procedure", 		"SP_FIA4100_Q");
		...
		logger.info("=============selectFia4100List=====end========");
	...
	public ResponseEntity<HashMap<String, Object>> modifyFia4100S(
		...
		logger.info("=============modifyFia4100S=====start========");
		HashMap<String,Object> resultMap = new HashMap<String,Object>();
		
		try {
			
			param.put("procedure", 		"SP_FIA4100_S");
			resultMap = apcMaCommDirectService.callProc(param, session, request, "");
	...
	public ResponseEntity<HashMap<String, Object>> modifyFia4100S1(
		...
		try {
			...
			param.put("procedure", 		"SP_FIA4100_S1");
			resultMap = apcMaCommDirectService.callProc(param, session, request, "");
