package com.apcmngsys.apcma.fi.fgl.leg.web;
 ...
 *
 * <pre>
 * << 거래처원장조회(Modification Information) >>
 *
 *  수정일      수정자		수정내용
 *  ----------	----------	---------------------------
 ...
 */
@Controller
public class ApcMaFig4170Controller extends BaseController {
    ...
    public ResponseEntity<HashMap<String, Object>> selectFig4170List(
    	...
    	logger.info("=============selectFig4170List=====start========");
    	HashMap<String,Object> resultMap = new HashMap<String,Object>();
    	
    	try {
    		
    		param.put("procedure", 		"SP_FIG4170_Q");
    	...
    	logger.info("=============selectFig4170List=====end========");
