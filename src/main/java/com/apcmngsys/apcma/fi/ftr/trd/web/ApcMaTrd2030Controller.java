package com.apcmngsys.apcma.fi.ftr.trd.web;
...
public class ApcMaTrd2030Controller extends BaseController {
    ...
    public ResponseEntity<HashMap<String, Object>> insertTrd2030(
        ...
        try {
            resultMap = apcMaComService.processForListData(param, session, request, "", "SP_TRD2030_S");
    ...
    public ResponseEntity<HashMap<String, Object>> insertTrd2030Confirm(
        ...
        try {
            resultMap = apcMaComService.processForListData(param, session, request, "", "SP_TRD2030_S1");
