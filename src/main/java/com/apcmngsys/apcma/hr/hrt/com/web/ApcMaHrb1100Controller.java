 ...
 */
@Controller
public class ApcMaHrb1100Controller extends BaseController {
    ...
    public ResponseEntity<HashMap<String, Object>> selectHrb1100List(
        ...
        logger.info("=============selectHrb1100List=====start========");
        HashMap<String,Object> resultMap = new HashMap<String,Object>();

        try {

            param.put("procedure", 		"SP_HRB1100_Q");
    ...
    public ResponseEntity<HashMap<String, Object>> insertHrb1100Master(
        ...
        try {
            ...
            param.put("procedure", 		"SP_HRB1100_S");
            resultMap = apcMaCommDirectService.callProc(param, session, request, "");
    ...
    public ResponseEntity<HashMap<String, Object>> insertHrb1100Sub(
        ...
        try {
            resultMap = apcMaComService.processForListData(param, session, request, "", "SP_HRB1100_S1");
