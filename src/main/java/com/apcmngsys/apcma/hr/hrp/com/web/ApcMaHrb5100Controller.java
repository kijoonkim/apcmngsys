 ...
 */
@Controller
public class ApcMaHrb5100Controller extends BaseController {
    ...
    public ResponseEntity<HashMap<String, Object>> selectHrb5100List(
            @RequestBody Map<String, Object> param
            , Model model
            , HttpSession session
            , HttpServletRequest request) throws Exception{

        logger.info("=============selectHrb5100List=====start========");
        HashMap<String,Object> resultMap = new HashMap<String,Object>();

        try {
            param.put("procedure", 		"SP_HRB5100_Q");
        ...
        logger.info("=============selectHrb5100List=====end========");
    ...
    public ResponseEntity<HashMap<String, Object>> insertHrb5100(
        ...
        try {
            param.put("procedure", 		"SP_HRB5100_S");
            resultMap = apcMaCommDirectService.callProc(param, session, request, "");
        } catch (Exception e) {
    ...
    public ResponseEntity<HashMap<String, Object>> insertHrb5100List(
        ...
        try {
            resultMap = apcMaComService.processForListData(param, session, request, "", "SP_HRB5100_S1");
