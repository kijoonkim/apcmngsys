package com.apcmngsys.apcss.am.tot.web;
...
public class TotMngController extends BaseController {
	...
	@PostMapping(value = "/am/tot/selectPrdctnVol.do", consumes = { MediaType.APPLICATION_JSON_VALUE, MediaType.TEXT_HTML_VALUE})
	    public ResponseEntity<HashMap<String, Object>> selectPrdctnVol(@RequestBody HashMap<String, Object> param, HttpServletRequest request) throws Exception {
	        HashMap<String, Object> resultMap = new HashMap<String, Object>();
			List<HashMap<String,Object>> resultList = new ArrayList<>();
	        try{
				resultList = totMngService.selectPrdctnVol(param);
	...
	@PostMapping(value = "/am/tot/selectAnlsList.do", consumes = { MediaType.APPLICATION_JSON_VALUE, MediaType.TEXT_HTML_VALUE})
	    public ResponseEntity<HashMap<String, Object>> selectAnlsList(@RequestBody HashMap<String, Object> param, HttpServletRequest request) throws Exception {
	        HashMap<String, Object> resultMap = new HashMap<String, Object>();
			List<HashMap<String, Object>> resultList = new ArrayList<>();
	        try{
	            resultList = totMngService.selectAnlsList(param);
	        }catch (Exception e) {
	            return getErrorResponseEntity(e);
	        } finally {
	            HashMap<String, Object> rtnObj = setMenuComLog(request);
