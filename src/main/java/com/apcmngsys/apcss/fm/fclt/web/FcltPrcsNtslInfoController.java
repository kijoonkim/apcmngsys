...
import com.apcmngsys.apcss.fm.fclt.service.FcltPrcsNtslInfoService;
import com.apcmngsys.apcss.fm.fclt.vo.FcltPrcsNtslInfoVO;
...
public class FcltPrcsNtslInfoController extends BaseController {
	...
	public ResponseEntity<HashMap<String, Object>> selectFcltPrcsNtslInfoList(Model model, @RequestBody FcltPrcsNtslInfoVO fcltPrcsNtslInfoVO, HttpServletRequest request) throws Exception{
	...
	// 로우데이터 조회
	@PostMapping(value = "/fm/fclt/selectFcltPrcsNtslInfoRawDataList.do", consumes = {MediaType.APPLICATION_JSON_VALUE , MediaType.TEXT_HTML_VALUE})
	public ResponseEntity<HashMap<String, Object>> selectFcltPrcsNtslInfoRawDataList(Model model, @RequestBody FcltPrcsNtslInfoVO fcltPrcsNtslInfoVO, HttpServletRequest request) throws Exception{

		HashMap<String,Object> resultMap = new HashMap<String,Object>();
		List<FcltPrcsNtslInfoVO> resultList = new ArrayList<>();

		fcltPrcsNtslInfoVO.setUserId(getUserId());
		fcltPrcsNtslInfoVO.setUserType(getUserType());

		try {
			 resultList = fcltPrcsNtslInfoService.selectFcltPrcsNtslInfoRawDataList(fcltPrcsNtslInfoVO);
