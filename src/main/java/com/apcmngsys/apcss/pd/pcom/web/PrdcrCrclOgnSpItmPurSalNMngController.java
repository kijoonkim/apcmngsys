...
import com.apcmngsys.apcss.pd.pcom.service.PrdcrCrclOgnSpItmPurSalNMngService;
import com.apcmngsys.apcss.pd.pcom.vo.PrdcrCrclOgnSpItmPurSalNMngVO;
...
public class PrdcrCrclOgnSpItmPurSalNMngController extends BaseController{
	...
	// 조회
	@PostMapping(value = "/pd/pcom/selectPrdcrCrclOgnSpItmPurSalNMngRawDataList.do", consumes = {MediaType.APPLICATION_JSON_VALUE , MediaType.TEXT_HTML_VALUE})
	public ResponseEntity<HashMap<String, Object>> selectRawDataList(Model model, @RequestBody PrdcrCrclOgnSpItmPurSalNMngVO PrdcrCrclOgnSpItmPurSalNMngVO, HttpServletRequest request) throws Exception{
		HashMap<String,Object> resultMap = new HashMap<String,Object>();
		List<PrdcrCrclOgnSpItmPurSalNMngVO> resultList = new ArrayList<>();
		try {
			 resultList = PrdcrCrclOgnSpItmPurSalNMngService.selectRawDataList(PrdcrCrclOgnSpItmPurSalNMngVO);
		} catch (Exception e) {
			logger.debug(e.getMessage());
			return getErrorResponseEntity(e);
		}
	...
	public ResponseEntity<HashMap<String, Object>> selectPrdcrCrclOgnSpItmPurSalNMngListNew(Model model, @RequestBody PrdcrCrclOgnSpItmPurSalNMngVO PrdcrCrclOgnSpItmPurSalNMngVO, HttpServletRequest request) throws Exception{
		HashMap<String,Object> resultMap = new HashMap<String,Object>();
		List<PrdcrCrclOgnSpItmPurSalNMngVO> resultList = new ArrayList<>();
		PrdcrCrclOgnSpItmPurSalNMngVO result = new PrdcrCrclOgnSpItmPurSalNMngVO();
		try {
			resultList = PrdcrCrclOgnSpItmPurSalNMngService.selectPrdcrCrclOgnSpItmPurSalNMngListNew(PrdcrCrclOgnSpItmPurSalNMngVO);
			result = PrdcrCrclOgnSpItmPurSalNMngService.selectTempSaveUoPst(PrdcrCrclOgnSpItmPurSalNMngVO);
		} catch (Exception e) {
			logger.debug(e.getMessage());
			return getErrorResponseEntity(e);
		}
