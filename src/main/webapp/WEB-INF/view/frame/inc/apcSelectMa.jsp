...
console.log('gv_ma_selectedClntCd:', gv_ma_selectedClntCd);
...
console.log('cjsonApcList:', cjsonApcList);		
...
console.log('gv_ma_selectedCorpNm:', gv_ma_selectedCorpNm);		
		...
		const cfn_onChangeApc = function(obj) {
			gv_ma_selectedCorpCd = obj.value	//obj.value;
			gv_ma_selectedCorpNm = obj.text	//obj.text;
		}
	...
	<c:choose>
		...
		<c:otherwise>
			<c:set scope="request" var="corpNm" value="${loginVO.corpNm}"></c:set>
			<sbux-input
				id="gsb-slt-apcCd"
				name="gsb-slt-apcCd"
				uitype="text"
