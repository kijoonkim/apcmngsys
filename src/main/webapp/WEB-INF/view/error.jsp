...
<head>
<meta charset="utf-8">
<title>▒▒▒  eGovFrame APC정보지원시스템  ▒▒▒</title>
...
<div style="width: 1000px; margin: 50px auto 50px;">
	...
	<p style="font-size: 18px; color: #000; margin-bottom: 10px; "><img src="<c:url value='/resource/images/header_logo.png' />" width="379" height="57" /></p>
