...
<%--</svg>--%>
    ...
    <span id="pop_wrap" style="position:absolute;left: 30px; border-radius:50%;text-align:center;background: #ffffff;width: 15px;height: 15px;line-height: 15px;">
        <p id="pop_cnt" style="font-weight: bold; color: #149fff"></p>
    </span>
            </div>
