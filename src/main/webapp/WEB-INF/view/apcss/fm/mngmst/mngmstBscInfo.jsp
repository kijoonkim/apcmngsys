...
<script type="text/javascript">
	...
	function fn_createspmtDsctnGrid() {
        ...
        SBGridProperties.columns = [
            {caption: ['순번'], 				ref: 'wghno',		width: '17%', type: 'output'},
            {caption: ['고유번호'], 		ref: 'prdcrNm', 	width: '14%', type: 'output'},
            {caption: ['업체명'],				ref: 'itemNm', 		width: '14%', type: 'output'},
            {caption: ['주소'],				ref: 'itemNm2', 		width: '14%', type: 'output'},
            {caption: ['지역'],				ref: 'itemNm3', 		width: '14%', type: 'output'},
            {caption: ['품목'],				ref: 'itemNm4', 		width: '14%', type: 'output'},
            {caption: ['품종'],				ref: 'itemNm5', 		width: '14%', type: 'output'},
        ];
