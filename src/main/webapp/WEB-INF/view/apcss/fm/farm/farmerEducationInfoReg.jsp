...
<script type="text/javascript">
	...
	const fn_subUpdate = async function (isConfirmed){
		...
		const postJsonPromise = gfn_postJSON("/fm/farm/insertFarmerEducationInfoReg.do", {
					...
					, crclmCd: SBUxMethod.get('dtl-input-crclmCd')
					, flNm: SBUxMethod.get('dtl-input-flNm')
					, ednstNm: SBUxMethod.get('dtl-input-ednstNm')
					, crclmNm: SBUxMethod.get('dtl-input-crclmNm')
					, eduBgngYmd: SBUxMethod.get('dtl-input-eduBgngYmd')
					, eduEndYmd: SBUxMethod.get('dtl-input-eduEndYmd')
					, idntyYn: SBUxMethod.get('dtl-input-idntyYn')
			});
