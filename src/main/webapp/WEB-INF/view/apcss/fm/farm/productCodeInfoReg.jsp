...
// 	        {caption: ["통합조직 코드"], 	ref: 'iiCode',   	type:'input', hidden:true},
	...
	const fn_searchfarmList = async function(){
        ...
        try{
        	jsonproductCodeInfoReg.length = 0;
        	console.log("data==="+data);
        	data.resultList.forEach((item, index) => {
				let productCodeInfoRegVO = {
				...
				jsonproductCodeInfoReg.push(productCodeInfoRegVO);
			});
...
// 			let postJsonPromise = gfn_postJSON("/fm/farm/multiSaveproductCodeInfoRegList.do", saveList);
// 	        let data = await postJsonPromise;
// 	        try {
