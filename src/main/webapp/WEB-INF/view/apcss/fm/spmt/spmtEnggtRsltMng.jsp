...
<body>
	<section class="content container-fluid">
		...
		<div class="box-header" style="display:flex; justify-content: flex-start;" >
			<div>
				<h3 class="box-title" style="line-height: 30px;">▶출하약정실적관리</h3>
			</div>
			...
			<div class="box-body">
				...
				<table class="table table-bordered tbl_row tbl_fixed">
		            ...
		            <div class="sbt-wrap-body">
		               <div class="sbt-grid">
						<div id="sb-area-grdSpmtCmndTrgtDsctn2" style="height:150px;"></div>
		               </div>
		            </div>
...
<script type="text/javascript">
    ...
    //grid2 초기화
    var grdComMsgList2; // 그리드를 담기위한 객체 선언
    var jsonComMsgList2 = []; // 그리드의 참조 데이터 주소 선언

    function fn_createGrid2() {
        var SBGridProperties = {};
	    SBGridProperties.parentid = 'sb-area-grdSpmtCmndTrgtDsctn2';
	    SBGridProperties.id = 'grdComMsgList2';
	    SBGridProperties.jsonref = 'jsonComMsgList2';
        SBGridProperties.emptyrecords = '데이터가 없습니다.';
        SBGridProperties.selectmode = 'byrow';
	    SBGridProperties.explorerbar = 'sortmove';
        SBGridProperties.rowheader = 'seq';
        ...
        SBGridProperties.columns = [
            {caption: ["출하일자"],	 ref: 'msgKey2',      type:'output',  width:'20%',    style:'text-align:center'},
            {caption: ["생산자"], 	 ref: 'msgCn2',     	type:'output',   width:'20%',    style:'text-align:left'},
            {caption: ["품목"],   	 ref: 'msgKndNm2',    type:'output',  width:'20%',    style:'text-align:center'},
            {caption: ["출하실적량"],    ref: 'rmrk2',        type:'output',  width:'20%',    style:'text-align:center'},
            {caption: ["입고"], 	 ref: 'creUserId2',   type:'output',  width:'20%',    style:'text-align:center'},
            {caption: ["최종변경일시"],  ref: 'updDateTime2', type:'output',  hidden: true},
            {caption: ["등록프로그램"],  ref: 'creProgram2',  type:'output',  hidden: true},
            {caption: ["변경프로그램"],  ref: 'updProgram2',  type:'output',  hidden: true}
        ];

        grdComMsgList2 = _SBGrid.create(SBGridProperties);
        grdComMsgList2.bind('click', 'fn_view');
        //grdComMsgList2.bind('beforepagechanged2', 'fn_pagingComMsgList2');
    }
