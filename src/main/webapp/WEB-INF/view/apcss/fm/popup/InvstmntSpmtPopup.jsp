		...
		<div class="box box-solid">
			<div class="box-header" style="display:flex; justify-content: flex-start;" >
				...
				<div style="margin-left: auto;">
					...
					<sbux-button id="btnSearchInvstmntSpmt" name="btnSearchInvstmntSpmt" uitype="normal" text="조회" class="btn btn-sm btn-outline-danger" onclick="popInvstmntSpmt.search" onkeyup="enterKey();"></sbux-button>
				...
				<table class="table table-bordered tbl_row tbl_fixed">
					...
					<tbody>
						<tr>
							...
							<td colspan="2">
								<sbux-input id="srch-inp-code" name="srch-inp-code" uitype="text" class="form-control input-sm" onkeyenter="enterKey();"></sbux-input>
							</td>
							<th scope="row">조직명</th>
							<td colspan="2">
								<sbux-input id="srch-inp-codeNm" name="srch-inp-codeNm" uitype="text" class="form-control input-sm" onkeyenter="enterKey();"></sbux-input>
							</td>
						</tr>
						<tr>
							<th scope="row">생산유통통합조직여부</th>
							<td>
								<sbux-select id="srch-slt-spmtType" name="srch-slt-mainGbn" uitype="single" class="form-control input-sm" unselected-text="선택">
							...
							<td>
								<sbux-select id="srch-slt-spmtType" name="srch-slt-subGbn" uitype="single" class="form-control input-sm" unselected-text="선택">
									<option-item value="Y">Y</option-item>
									<option-item value="N">N</option-item>
								</sbux-select>
							</td>
