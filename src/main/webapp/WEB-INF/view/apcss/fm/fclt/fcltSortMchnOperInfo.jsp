<%
 /**
  * @Class Name : fcltSortMchnOperInfo.jsp
  * @Description : 선별기운영기간 화면
  * @author SI개발부
  * @since 2023.12.12
  * @version 1.0
...
<script type="text/javascript">
	...
	const fn_hiddenGrdSelect = async function(){
		...
		let postJsonPromise = gfn_postJSON("/fm/fclt/selectFcltSortMchnOperInfoRawDataList.do", {
			crtrYr : crtrYr
		});
	...
	function fn_excelDown(){
		...
		let fileName = formattedDate + "_3.4선별기운영기간_로우데이터";
