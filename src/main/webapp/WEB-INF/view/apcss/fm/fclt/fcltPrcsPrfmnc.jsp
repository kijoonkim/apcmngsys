					...
					<colgroup>
						...
						<thead>
							<tr>
								...
								<th class="th_bg" rowspan="2">APC 취급액</th>
								<th class="th_bg" rowspan="2">APC 일반취급(단순 매취 등)</th>
								<th class="th_bg" colspan="2">APC 조직화취급</th>
							</tr>
							<tr>
								<th class="th_bg">공선수탁</th>
								<th class="th_bg">계약매취</th>
							</tr>
							<tr>
								<td class="td_input">
									<sbux-input id="dtl-input-fcltPrcsSeCd" name="dtl-input-fcltPrcsSeCd" uitype="text" class="form-control input-sm" placeholder="금액(백만원)" ></sbux-input>
								</td>
								<td class="td_input">
									<sbux-input id="dtl-input-fcltPrcsTrmtAmt " name="dtl-input-fcltPrcsTrmtAmt " uitype="text" class="form-control input-sm" placeholder="17,100" ></sbux-input>
								</td>
								<td class="td_input">
									<sbux-input id="dtl-input-fcltPrcsTrmtCd" name="dtl-input-fcltPrcsTrmtCd" uitype="text" class="form-control input-sm" placeholder="-" ></sbux-input>
								</td>
								<td class="td_input">
									<sbux-input id="dtl-input-fcltPrcsTrmtCd2" name="dtl-input-fcltPrcsTrmtCd2" uitype="text" class="form-control input-sm" placeholder="15,800" ></sbux-input>
								</td>
								<td class="td_input">
									<sbux-input id="dtl-input-fcltPrcsTrmtCd3" name="dtl-input-fcltPrcsTrmtCd3" uitype="text" class="form-control input-sm" placeholder="1,300" ></sbux-input>
								</td>
							</tr>
							<tr>
								...
								<td colspan="3" class="td_input">
									<sbux-input id="dtl-input-apcCd" name="gsb-slt-apcCd" uitype="text" class="form-control input-sm" placeholder="apc코드" ></sbux-input>
								</td>
							</tr>
							<tr>
  ...
  <script type="text/javascript">
    ...
    function fn_createGrid() {
        ...
        SBGridProperties.columns = [
            ...
            {caption: ["구분"], 			ref: 'fcltPrcsSeCd',   		type:'output',  	width:'20%',    style:'text-align:center'},
            {caption: ["APC취급액"],  		ref: 'fcltPrcsTrmtAmt',  		type:'output',  	width:'20%',    style:'text-align:center'},
            {caption: ["APC일반취급"],  	ref: 'fcltPrcsTrmtCd',  		type:'output',  	width:'20%',    style:'text-align:center'},
            {caption: ["APC조직취급 공선수탁"],ref: 'fcltPrcsTrmtCd2',  		type:'output',  	width:'20%',    style:'text-align:center'},
            {caption: ["APC조직취급 계약매취"],ref: 'fcltPrcsTrmtCd3',  		type:'output',  	width:'20%',    style:'text-align:center'},
...
//예외처리
        try {
        	...
        	data.resultList.forEach((item, index) => {
				...
				sn: item.sn,     	 								//순번
				fcltPrcsSeCd: item.fcltPrcsSeCd,    				// 시설 처리 분류 코드
				fcltPrcsTrmtCd: item.fcltPrcsTrmtCd,     			// 시설 처리 취급 코드
				fcltPrcsTrmtAmt: item.fcltPrcsTrmtAmt,     			// 시설 처리 취급금액
    ...
    function fn_create() {
        ...
        SBUxMethod.set("dtl-input-fcltPrcsSeCd", null);   	         //  시설 처리 취급 코드
        SBUxMethod.set("dtl-input-fcltPrcsTrmtCd", null);   	         //  시설 처리 취급 코드
        SBUxMethod.set("dtl-input-fcltPrcsTrmtAmt", null);   	     //  시설 처리 취급금액
     ...
     const fn_clearForm = function() {
    	...
    	SBUxMethod.set("dtl-input-sn", null);    //순번
        SBUxMethod.set("dtl-input-fcltPrcsSeCd", null);    // 설비설치코드
        SBUxMethod.set("dtl-input-fcltPrcsTrmtCd", null);    //설비보유여부
        SBUxMethod.set("dtl-input-fcltPrcsTrmtAmt", null);    //설비보유여부
    ...
    const fn_subInsert = async function (isConfirmed){
    	...
    	const postJsonPromise = gfn_postJSON("/fm/fclt/insertFcltSortMchnOperInfo.do", {
            ...
            ,	fcltPrcsTrmtCd: SBUxMethod.set('dtl-input-fcltPrcsTrmtCd')   	     //  시설 처리 분류 코드
            ,	fcltPrcsTrmtCd: SBUxMethod.set('dtl-input-fcltPrcsTrmtCd')   	     //  시설 처리 취급 코드
            ,	fcltPrcsTrmtAmt: SBUxMethod.set('dtl-input-fcltPrcsTrmtAmt')   	     //  시설 처리 취급금액
	...
	const fn_subUpdate = async function (isConfirmed){
        ...
        ,	sn: SBUxMethod.set('dtl-input-sn')   	     			 			 //	 순번
        ,	fcltPrcsSeCd: SBUxMethod.set('dtl-input-fcltPrcsSeCd')  	  	     //	 시설 처리 분류 코드
        ,	fcltPrcsTrmtCd: SBUxMethod.set('dtl-input-fcltPrcsTrmtCd')         	 //	 시설 처리 취급 코드
        ,	fcltPrcsTrmtAmt: SBUxMethod.set('dtl-input-fcltPrcsTrmtAmt')         //	 시설 처리 취급금액
        ,	delYn: SBUxMethod.get('dtl-input-delYn')                  			 //	 삭제유무
        ,	sysFrstInptDt: SBUxMethod.get('dtl-input-sysFrstInptDt')      	  	 //	 시스템최초입력일시
    ...
    const fn_subDelete = async function (isConfirmed, list){
     	...
     	const postJsonPromise = gfn_postJSON("/fm/fclt/deleteFcltSortMchnOperInfo.do", list);
...
//예외처리
    ...
    function fn_view() {
    	...
    	SBUxMethod.set("dtl-input-fcltPrcsSeCd", rowData.fcltPrcsSeCd);     //설비설치코드
    	SBUxMethod.set("dtl-input-fcltPrcsTrmtCd", rowData.fcltPrcsTrmtCd);         //설비보유여부
    	SBUxMethod.set("dtl-input-fcltPrcsTrmtAmt", rowData.fcltPrcsTrmtAmt);         //설비보유여부
    }
