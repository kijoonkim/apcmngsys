					...
					<colgroup>
						...
						<thead>
							<tr>
								...
								<th rowspan="2">APC 일반취급(단순 매취 등)</th>
							...
							<tr>
								<td>
									<sbux-input id="srch-inp-opera1" name="srch-inp-opera1" uitype="text" class="form-control input-sm" placeholder="금액(백만원)" ></sbux-input>
								</td>
								<td>
									<sbux-input id="srch-inp-opera2" name="srch-inp-opera2" uitype="text" class="form-control input-sm" placeholder="17,100" ></sbux-input>
								</td>
								<td>
									<sbux-input id="srch-inp-opera3" name="srch-inp-opera3" uitype="text" class="form-control input-sm" placeholder="-" ></sbux-input>
								</td>
								<td>
									<sbux-input id="srch-inp-opera3" name="srch-inp-opera4" uitype="text" class="form-control input-sm" placeholder="15,800" ></sbux-input>
								</td>
								<td>
									<sbux-input id="srch-inp-opera3" name="srch-inp-opera5" uitype="text" class="form-control input-sm" placeholder="1,300" ></sbux-input>
								</td>
							</tr>
...
<script type="text/javascript">
	...
	function fn_createspmtDsctnGrid() {
        ...
        SBGridProperties.columns = [
            ...
            {caption: ['APC취급액','APC취급액'], 		ref: 'prdcrNm', 	width: '16%', type: 'output'},
            {caption: ['APC취급물','단순수탁'],			ref: 'itemNm', 		width: '16%', type: 'output'},
            {caption: ['APC취급물','단순매취'], 			ref: 'vrtyNm', 		width: '16%', type: 'output'},
            {caption: ['APC조직화취급','공선수탁'], 		ref: 'gdsSeNm', 	width: '12%', type: 'output'},
            {caption: ['APC조직화취급','계약매취'], 		ref: 'wrhsSeNm', 	width: '24%', type: 'output'},
        ];
