...
<script type="text/javascript">
    ...
    function fn_createGrid() {
        ...
        SBGridProperties.columns = [
            {caption: ["없음"],	ref: 'msgKey',      type:'output',  width:'8%',    style:'text-align:center'},
            {caption: ["1월"], 	ref: 'msgCn',     	type:'output',  width:'8%',    style:'text-align:center'},
            {caption: ["2월"],  	ref: 'msgKndNm',    type:'output',  width:'8%',    style:'text-align:center'},
            {caption: ["3월"],      	ref: 'rmrk1',        type:'output',  width:'8%',    style:'text-align:center'},
            {caption: ["4월"],      	ref: 'rmrk2',        type:'output',  width:'8%',    style:'text-align:center'},
            {caption: ["5월"],      	ref: 'rmrk3',        type:'output',  width:'8%',    style:'text-align:center'},
            {caption: ["6월"],      	ref: 'rmrk4',        type:'output',  width:'8%',    style:'text-align:center'},
            {caption: ["7월"],      	ref: 'rmrk5',        type:'output',  width:'8%',    style:'text-align:center'},
            {caption: ["8월"],      	ref: 'rmrk6',        type:'output',  width:'8%',    style:'text-align:center'},
            {caption: ["9월"],      	ref: 'rmrk7',        type:'output',  width:'8%',    style:'text-align:center'},
            {caption: ["10월"],      	ref: 'rmrk8',        type:'output',  width:'8%',    style:'text-align:center'},
            {caption: ["11월"],      	ref: 'rmrk9',        type:'output',  width:'8%',    style:'text-align:center'},
            {caption: ["12월"],      	ref: 'rmrk10',        type:'output',  width:'8%',    style:'text-align:center'}
