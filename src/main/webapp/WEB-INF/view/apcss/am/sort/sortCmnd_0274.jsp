        ...
        <div class="box box-solid">
            <div class="box-header" style="display: flex; justify-content: flex-start;">
                <div>
                    ...
                    <h3 class="box-title"> ▶ <c:out value='${menuNm}'></c:out></h3><!-- 선별지시조회(만인산) -->
                </div>
            ...
            <div class="box-body">
                ...
                <div class="sbt-wrap-body" style="padding-top: 10px;">
                    <div class="sbt-grid">
...
<script type="text/javascript">
    ...
    function fn_createSortCmndGrid() {
        ...
        SBGridProperties.columns = [
            ...
            {caption: ["지시번호"],		ref: 'sortCmndno',      type:'output',  	width:'130px',    style:'text-align:center'},
            {caption: ["지시일자"], 		ref: 'sortCmndYmd',     type:'output',  	width:'100px',    style:'text-align:center',
                format : {type:'date', rule:'yyyy-mm-dd', origin:'yyyymmdd'}},
            {caption: ["작업라인"],  		ref: 'prdcrNm',    		type:'output',  	width:'100px',    style:'text-align:center'},
            {caption: ["작업순번"],  			ref: 'vrtyNm',    		type:'output',  	width:'100px',    style:'text-align:center'},
            {caption: ["거래처"],  			ref: 'warehouseSeNm',   type:'output',  	width:'100px',    style:'text-align:center'},
            {caption: ["상품명"],  			ref: 'fcltNm',    		type:'output',  	width:'100px',    style:'text-align:center'},
            {caption: ["원물품종"],	ref: 'pltno',    		type:'output',  	width:'150px',    style:'text-align:center'},
            {caption: ["단위"],  		ref: 'cmndQntt',    	type:'output',  	width:'100px',    style:'text-align:right',
                format : {type:'number', rule:'#,###'}},
            {caption: ["지시수량"],  	ref: 'cmndWght',    	type:'output',  	width:'100px',    style:'text-align:right',
                format : {type:'number', rule:'#,###'}},
            {caption: ["비고"],  			ref: 'rmrk',    		type:'output',  	width:'180px',    style:'text-align:center'},
        ];
    ...
    */
    ...
    function fn_onSelectPrdcrNm(value, label, item) {
        ...
        if(jsonPrdcr.filter(e => e.prdcrNm === label).length > 1){
            document.getElementById('btnSrchVrty').click();
        } else{
