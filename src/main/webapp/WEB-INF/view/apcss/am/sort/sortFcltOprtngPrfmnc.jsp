<%
    /**
     * @Class Name : sortFcltOprtngPrfmnc.jsp
     * @Description : 가동 실적 등록(선별)
     * @author SI개발부
     * @since 2024.09.10
     * @version 1.0
        ...
        <div class="box box-solid">
            <div class="box-header" style="display:flex; justify-content: flex-start;">
                <div>
                    ...
                    <h3 class="box-title"> ▶ <c:out value='${menuNm}'></c:out></h3><!-- 가동 실적 등록(선별) -->
                </div>
...
<script>
    ...
    const fn_init = async function(){
        ...
        fn_search();
        SBUxMethod.set("dtl-slt-inptType","SORT_FCLT_CD");
    }
    ...
    const fn_search = async function(){
        ...
        try{
            ...
            let postJsonPromise = gfn_postJSON("/am/sort/selectSortFcltOprtngPrfmncList.do",{apcCd:gv_apcCd,fcltType : 'SORT_FCLT_CD',planYm : planYm});
