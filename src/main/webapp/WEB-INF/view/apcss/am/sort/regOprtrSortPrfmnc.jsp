				...
				<table class="table table-bordered tbl_row tbl_fixed">
					...
					<tbody>
						...
						<tr>
							...
							<td class="td_input" style="border-right: hidden;">
								<sbux-select id="select_single" name="select_single" uitype="single" unselected-text="선택"></sbux-select>         
							</td>
							<td class="td_input" style="border-right: hidden;">&nbsp;</td>
							<td class="td_input" style="border-right: hidden;">&nbsp;</td>
						</tr>
...
//     var SBGridProperties1 = {};
// 	    SBGridProperties1.parentid = 'sb-area-grdWrtrPrfmncDsctn2';
// 	    SBGridProperties1.id = 'grdComMsgList2';
// 	    SBGridProperties1.jsonref = 'jsonComMsgList2';
// 	    SBGridProperties1.emptyrecords = '데이터가 없습니다.';
// 	    SBGridProperties1.selectmode = 'byrow';
// 	    SBGridProperties1.extendlastcol = 'scroll';
// 	    SBGridProperties1.columns = [
...
//     ];
//     grdWghPrfmnc = _SBGrid.create(SBGridProperties2);
// }
