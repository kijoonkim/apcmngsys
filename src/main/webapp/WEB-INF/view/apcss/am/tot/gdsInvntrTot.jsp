...
<script type="text/javascript">
	...
	const fn_setGrdTotRslt = async function() {
		...
		try {
			...
			const postJsonPromise = gfn_postJSON("/am/tot/selectTotGdsInvntrList.do", {
				apcCd: gv_selectedApcCd,
				totCrtrType: __TOT_CRTR_TYPE__,
				termKndCd: termKndCd,
				crtrYmd: crtrYmd,
	...
	const fn_doc = async function() {
		...
		gfn_popClipReportPost("상품재고 집계", "am/totRsltGdsInvntr.crf",null, conn);
	}
</script>
