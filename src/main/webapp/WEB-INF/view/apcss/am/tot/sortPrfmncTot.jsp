...
<script type="text/javascript">
	...
	const fn_setGrdTotRslt = async function() {
		...
		try {
			...
			const postJsonPromise = gfn_postJSON("/am/tot/selectTotSortPrfmncList.do", {
				apcCd: gv_selectedApcCd,
				totCrtrType: __TOT_CRTR_TYPE__,
				termKndCd: termKndCd,
				crtrYmd: crtrYmd,
	...
	const fn_doc = async function() {
		...
		gfn_popClipReportPost("선별 실적집계", "am/totRsltSortPrfmnc.crf",null, conn);
	}
</script>
