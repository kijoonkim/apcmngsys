...
<script type="text/javascript">
	...
	const fn_setGrdTotRslt = async function() {
		...
		try {
			...
			const postJsonPromise = gfn_postJSON("/am/tot/selectTotPckgPrfmncList.do", {
				apcCd: gv_selectedApcCd,
				totCrtrType: __TOT_CRTR_TYPE__,
				termKndCd: termKndCd,
				crtrYmd: crtrYmd,
	...
	const fn_doc = async function() {
		...
		gfn_popClipReportPost("포장 실적집계", "am/totRsltPckgPrfmnc.crf",null, conn);
	}
</script>
