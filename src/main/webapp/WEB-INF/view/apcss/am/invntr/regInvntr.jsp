				 		...
				 		<table class="table table-bordered tbl_fixed">
							...
							<tbody>
								<tr>
									...
									<td class="td_input" style="border-right:hidden; border-left:hidden" >
										<sbux-button id="btnUld" name="btnUld" uitype="normal" text="올리기" class="btn btn-sm btn-outline-danger" onclick="fn_uld" style="float: right;"></sbux-button>
									</td>
								</tr>
							</tbody>
				 		</table>
			...
			expObjList.push(
				    {
						...
						columns: [
					    	...
					    	{caption: ["포장코드"],   	ref: 'value',  	type:'output',  width:'100px',    style:'text-align:center; background:#FFF8DC;'},
					    	{caption: ["포장단위명"],   ref: 'text',  	type:'output',  width:'100px',    style:'text-align:center; background:#FFF8DC;'}
						],
				        sheetName: "포장구분",
				        title: "",
				        unit: ""
