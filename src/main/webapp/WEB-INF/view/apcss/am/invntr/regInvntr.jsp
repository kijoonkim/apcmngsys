...
<script type="text/javascript">
	...
	const fn_selectVrty = async function(obj){
	...
	const fn_createGridRawMtr = async function () {
	    ...
	    SBGridProperties.columns = [
	        ...
	        {caption: ["변경비고","변경비고"],		ref: 'chgRmrk',      		type:'input',  		width:'105px',	  style:'text-align:left',
    ...
    /* 생산자 팝업 호출 필수 function  */
 	...
 	const fn_setPrdcr = async function(prdcr) {
 		...
 		if (!gfn_isEmpty(prdcr)) {
 			...
 			await fn_selectVrty({value: prdcr.itemVrtyCd});
