			...
			<div class="box-body">
				...
				<table class="table table-bordered tbl_fixed">
					...
					<tbody>
						...
						<tr>
							<th class="ta_r th_bg" scope="row">육안선별등록</th>
							<td class="td_input" colspan="2">
...
<!-- 						</tr> -->
    ...
    <!-- 육안선별등록 Modal -->
    <div>
        <sbux-modal id="modal-bffaSortReg" name="modal-bffaSortReg" uitype="middle" header-title="육안선별등록" body-html-id="body-modal-bffaSortReg" footer-is-close-button="false" header-is-close-button="false" style="width:1000px"></sbux-modal>
    </div>
...
<script type="text/javascript">
	...
	var jsonComboVlType = [
		{text: "중량", label: "중량", value: "WGHT"},
		{text: "수량", label: "수량", value: "QNTT"},
	];
	var jsonComboUseYn = [
            ...
            if (grid === "grdCnpt") {
            	...
            	if(grdRgnTrsprtCst.getRowStatus(nRow) == 0 || grdRgnTrsprtCst.getRowStatus(nRow) == 2){
            		if(gfn_comConfirm("Q0001", "등록된 행입니다. 삭제")){
            			...
            			fn_deleteRgnTrsprtCstList(rgnTrsprtCst, nRow);
            		}
            	}else{
            	...
            	if(grdWrhsVhcl.getRowStatus(nRow) == 0 || grdWrhsVhcl.getRowStatus(nRow) == 2){
            		if(gfn_comConfirm("Q0001", "등록된 행입니다. 삭제")){
            			...
            			fn_deleteWrhsVhclList(wrhsVhclVo, nRow);
            		}
            	}else{
