			...
			<div class="box-body">
				...
				<div class="row">
					<div class="col-sm-4">
						...
						<div id="sb-area-grdWrhsSe" style="height:258px;"></div>
						...
						<div id="sb-area-grdWarehousSe" style="height:258px;"></div>
					...
					<div class="col-sm-4">
						...
						<div id="sb-area-grdGdsSe" style="height:258px;"></div>
						...
						<div id="sb-area-grdSortFclt" style="height:258px;"></div>
					</div>
					...
					<div class="col-sm-4">
						...
						<div id="sb-area-grdTrsprtSe" style="height:258px;"></div>
						...
						<div id="sb-area-grdPckgFclt" style="height:258px;"></div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-4">
				...
				<div class="row">
					<div class="col-sm-4">
						...
						<div id="sb-area-grdPrdcr" style="height:258px;"></div>
					</div>
					...
					<div class="col-sm-8">
						...
						<div id="sb-area-grdPltBx" style="height:258px;"></div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-4">
						...
						<div id="sb-area-grdVhclInfo" style="height:258px;"></div>
					</div>
					...
					<div class="col-sm-4">
						...
						<div id="sb-area-grdTrsprtCo" style="height:258px;"></div>
					</div>
					<div class="col-sm-4">
						<div class="ad_tbl_top" style="margin-bottom: 10px;">
							<ul class="ad_tbl_count" style="width: 100%">
						...
						<div id="sb-area-grdDlng" style="height:258px;"></div>
					</div>
				</div>
...
const fn_createWrhsSeGrid = function() {
    ...
    SBGridProperties.columns = [
    	{caption : ["코드"], ref: 'cd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px; '},
    	{caption : ["코드명"], ref: 'cdNm', type: 'output',  width:'100px', style: 'text-align:center; padding-right:5px;'},
    ];
...
const fn_createWarehouseGrid = function() {
    ...
    SBGridProperties.columns = [
    	{caption : ["코드"], ref: 'cd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px; '},
    	{caption : ["코드명"], ref: 'cdNm', type: 'output',  width:'100px', style: 'text-align:center; padding-right:5px;'},
    	{caption : ["연계코드"], ref: 'linkCd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'},
...
const fn_createItemGrid = function() {
    ...
    SBGridProperties.allowcopy = true;
    SBGridProperties.columns = [
    	{caption : ["품목코드"], ref: 'itemCd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px; '},
...
const fn_createVrtyGrid = function() {
    ...
    SBGridProperties.columns = [
    	{caption : ["품목코드"], ref: 'itemCd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px; '},
    	{caption : ["품목명"], ref: 'itemNm', type: 'output',  width:'100px', style: 'text-align:center; padding-right:5px;'},
    	{caption : ["품종코드"], ref: 'vrtyCd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'},
...
const fn_createSpcfctGrid = function() {
    ...
    SBGridProperties.columns = [
    	{caption : ["품목코드"], ref: 'itemCd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px; '},
    	{caption : ["품목명"], ref: 'itemNm', type: 'output',  width:'100px', style: 'text-align:center; padding-right:5px;'},
    	{caption : ["규격코드"], ref: 'spcfctCd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'},
...
const fn_createGrdGrid = function() {
    ...
    SBGridProperties.columns = [
    	{caption : ["품목코드"], ref: 'itemCd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px; '},
    	{caption : ["품목명"], ref: 'itemNm', type: 'output',  width:'100px', style: 'text-align:center; padding-right:5px;'},
    	{caption : ["등급구분"], ref: 'grdSe', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px; '},
    	{caption : ["종류코드"], ref: 'kndCd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'},
    	{caption : ["등급종류"], ref: 'grdKnd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'},
    	{caption : ["등급코드"], ref: 'grdCd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'},
    	{caption : ["등급명"], ref: 'grdNm', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'},
...
const fn_createGdsGrid = function() {
    ...
    SBGridProperties.columns = [
    	...
    	{caption : ["규격코드"], ref: 'spcfctCd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'},
    	{caption : ["규격명"], ref: 'spcfctNm', type: 'output',  width:'100px', style: 'text-align:center; padding-right:5px;'},
    	{caption : ["상품코드"], ref: 'gdsCd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'},
    	{caption : ["상품명"], ref: 'gdsNm', type: 'output',  width:'100px', style: 'text-align:center; padding-right:5px;'},
...
const fn_createPrdcrGrid = function() {
    ...
    SBGridProperties.columns = [
    	{caption : ["코드"], ref: 'cd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px; '},
    	{caption : ["생산자명"], ref: 'prdcrNm', type: 'output',  width:'100px', style: 'text-align:center; padding-right:5px;'},
    	{caption : ["비고"], ref: 'rmrk', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'}
    ];
...
const fn_createPltBxGrid = function() {
    ...
    SBGridProperties.allowcopy = true;
    SBGridProperties.columns = [
    	{caption : ["구분"], ref: 'se', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px; '},
    	{caption : ["코드"], ref: 'cd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'},
    	{caption : ["코드명"], ref: 'cdNm', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'}
    ];
...
const fn_createVhclInfoGrid = function() {
    ...
    SBGridProperties.allowcopy = true;
    SBGridProperties.columns = [
    	{caption : ["차량번호"], ref: 'vhclNo', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px; '},
    	{caption : ["기사명"], ref: 'drvrNm', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'},
    	{caption : ["비고"], ref: 'rmrk', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'}
    ];
...
const fn_createTrsprtCoGrid = function() {
    ...
    SBGridProperties.columns = [
    	{caption : ["코드"], ref: 'cd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px; '},
    	{caption : ["운송사명"], ref: 'trsprtCoNm', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'},
    ];
    grdTrsprtCo = _SBGrid.create(SBGridProperties);
}

const fn_createDlngGrid = function() {
    var SBGridProperties = {};
    SBGridProperties.parentid = 'sb-area-grdDlng';
    SBGridProperties.id = 'grdDlng';
    SBGridProperties.jsonref = 'jsonDlng';
    SBGridProperties.emptyrecords = '데이터가 없습니다.';
    SBGridProperties.selectmode = 'free';
    SBGridProperties.extendlastcol = 'scroll';
    SBGridProperties.mergecells = 'bycolrec';
    ...
    SBGridProperties.columns = [
    	{caption : ["코드"], ref: 'cd', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px; '},
    	{caption : ["거래처명"], ref: 'dlngNm', type: 'output',  width:'50px', style: 'text-align:center; padding-right:5px;'},
    ];
    grdTrsprtCo = _SBGrid.create(SBGridProperties);
}
