		...
		<div class="box box-solid">
			<div class="box-header" style="display:flex; justify-content: flex-start;" >
				<div>
					...
					<h3 class="box-title"> ▶ <c:out value='${menuNm}'></c:out></h3><!-- 포장실적등록 -->
				</div>
...
<script type="text/javascript">
	...
	function fn_createGridPckgPrfmnc() {
        ...
        const columns2 = [
            ...
            {caption: ["포장중량 (Kg)"], 			ref: 'pckgWght',  		type:'input',  width:'80px', style: 'text-align:right;',
		...
		allInvntrData.forEach((item, index) => {
			if (item.checkedYn === "Y") {
    			...
    			sortInvntrList.push({
    				...
    				sortSn: item.sortSn,
    				pckgCmndno: item.pckgCmndno,
    				sortInptPrgrsYn: item.sortInptPrgrsYn,
    				inptQntt: inptQntt,
    				inptWght: inptWght
    			});
		...
		let iCol = 0;
 		for ( let iRow = 1; iRow <= impData.length; iRow++ ) {
 	    	...
 	    	*/
 			...
 			if (gfn_isEmpty(rowData.spmtPckgUnitCd)) {
 				gfn_comAlert("W0001", "상품명");		//	W0005	{0}이/가 없습니다.
 				return;
 			}
