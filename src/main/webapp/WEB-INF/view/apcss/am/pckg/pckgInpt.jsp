...
<script type="text/javascript">
	...
	function fn_createGrid() {
        ...
        SBGridProperties.columns = [
            ...
            {caption: ['지시번호','지시번호'], 	ref: 'pckgCmndno', 		width: '100px', type: 'output', style:'text-align:center'},
            ...
            {caption: ['재고','수량'], 			ref: 'invntrQntt', 		width: '60px', 	type: 'output', style:'text-align:right',
            	format : {type:'number', rule:'#,###'}
            },
            {caption: ['재고','중량'], 			ref: 'invntrWght', 		width: '60px', 	type: 'output', style:'text-align:right',
            	format : {type:'number', rule:'#,###'}
            },
            ...
            {caption: ['포장','수량'], 			ref: 'pckgQntt', 		width: '60px', 	type: 'output', style:'text-align:right',
            	format : {type:'number', rule:'#,###'}
            },
            {caption: ['포장','중량'], 			ref: 'pckgWght', 		width: '60px', 	type: 'output', style:'text-align:right',
            	format : {type:'number', rule:'#,###'}
            },
            {caption: ['출하','수량'], 			ref: 'spmtQntt', 		width: '60px', 	type: 'output', style:'text-align:right',
            	format : {type:'number', rule:'#,###'}
            },
            {caption: ['출하','중량'], 			ref: 'spmtWght', 		width: '60px', 	type: 'output', style:'text-align:right',
            	format : {type:'number', rule:'#,###'}
            },
            ...
            {caption: ['',''], 				ref: '_', 				width: '1px', 	type: 'output', style:'text-align:center'
            }
        ];
