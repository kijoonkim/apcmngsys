  ...
  <div class="box box-solid">
    <div class="box-header" style="display:flex; justify-content: flex-start;">
      <div>
        ...
        <h3 class="box-title"> ▶ <c:out value='${menuNm}'></c:out></h3><!-- 반품 실적 조회(상품) -->
      </div>
      <%--            /** 상단 버튼 **/--%>
...
<script type="application/javascript">
  ...
  const fn_create_rtnCrtr = async function(){
    ...
    SBGridProperties.columns = [
      ...
      {caption: ["품목"],	ref: 'wghYmd',		type:'output',  width:'8%', style: 'text-align:center;'},
      {caption: ["품종"],	ref: 'wghFcltCd',		type:'output',  width:'8%', style: 'text-align:center;'},
      {caption: ["생산자"],	ref: 'wghno',	type:'output',  width:'8%', style: 'text-align:center;'},
      {caption: ["상세구분"],	ref: 'wghno',	type:'output',  width:'8%', style: 'text-align:center;'},
      {caption: ["폐기번호"],	ref: 'vhclno',		type:'output',  width:'8%', style: 'text-align:center;'},
      {caption: ["수량"],	ref: 'vhclno',		type:'output',  width:'8%', style: 'text-align:center;'},
      {caption: ["중량"],	ref: 'vhclno',		type:'output',  width:'8%', style: 'text-align:center;'},
      {caption: ["상세코드"],	ref: 'vhclno',		type:'output',  width:'8%', style: 'text-align:center;'},
      {caption: ["폐기사유"],	ref: 'vhclno',		type:'output',  width:'31%', style: 'text-align:center;'},
    ]
