      ...
      <table class="table table-bordered tbl_fixed">
        ...
        <tr>
          ...
          <td class="td_input" colspan="4" style="border-right: hidden;border-top: hidden">
            <sbux-select id="srch-slt-sortFcltCd1"
                         name="srch-slt-sortFcltCd1"
                         uitype="single"
                         unselected-text="전체"
                         class="form-control input-sm"
                         style="width: 80%"
...
<script type="application/javascript">
  ...
  const fn_create_rtnCrtr = async function(){
    ...
    SBGridProperties.columns = [
      ...
      {caption: ["재고유형"],	ref: 'wghYmd',		type:'output',  width:'14%', style: 'text-align:center;'},
      {caption: ["기준유형코드"],	ref: 'wghFcltCd',		type:'output',  width:'14%', style: 'text-align:center;'},
      {caption: ["기준유형명칭"],	ref: 'wghFcltCd',		type:'output',  width:'14%', style: 'text-align:center;'},
      {caption: ["기준코드"],	ref: 'wghno',	type:'output',  width:'14%', style: 'text-align:center;'},
      {caption: ["기준 비고"],	ref: 'vhclno',		type:'output',  width:'39%', style: 'text-align:center;'},
    ]
