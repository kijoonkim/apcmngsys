            ...
            <table class="table table-bordered tbl_fixed">
                ...
                <tr>
                    ...
                    <td class="td_input" colspan="3" style="border-right: hidden;">
                        <sbux-datepicker id="srch-dtl-wghYmd"
                                         name="srch-dtl-wghYmd"
...
<script type="application/javascript">
    ...
    const fn_create_rtnCrtr = async function(){
        ...
        SBGridProperties.columns = [
            {caption: ["기준명"],	ref: 'fcltCd',		type:'output',  width:'12%', style: 'text-align:center;'},
            {caption: ["계획일자"],	ref: 'wghYmd',		type:'output',  width:'12%', style: 'text-align:center;'},
            {caption: ["계획번호"],	ref: 'wghFcltCd',		type:'output',  width:'12%', style: 'text-align:center;'},
            ...
            {caption: ["저장위치"],	ref: 'wghno',	type:'output',  width:'12%', style: 'text-align:center;'},
            {caption: ["실사여부"],	ref: 'vhclno',		type:'output',  width:'12%', style: 'text-align:center;'},
            {caption: ["비고"],	ref: 'vhclno',		type:'output',  width:'16%', style: 'text-align:center;'},
        ]
