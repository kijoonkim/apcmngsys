...
<script type="application/javascript">
  ...
  const fn_create_rtnCrtr = async function(){
    ...
    SBGridProperties.columns = [
      {caption: ["재고유형"],	ref: 'wghYmd',		type:'output',  width:'12%', style: 'text-align:center;'},
      ...
      {caption: ["재고번호"],	ref: 'wghno',	type:'output',  width:'14%', style: 'text-align:center;'},
      {caption: ["재고상세"],	ref: 'vhclno',		type:'output',  width:'14%', style: 'text-align:center;'},
      {caption: ["입고유형"],	ref: 'vhclno',		type:'output',  width:'12%', style: 'text-align:center;'},
      {caption: ["상품구분"],	ref: 'vhclno',		type:'output',  width:'12%', style: 'text-align:center;'},
      {caption: ["운송구분"],	ref: 'vhclno',		type:'output',  width:'12%', style: 'text-align:center;'},
    ]
