...
<script type="application/javascript">
    ...
    const fn_create_rtnCrtr = async function(){
        ...
        SBGridProperties.columns = [
            ...
            {caption: ["거래처"],	ref: 'wghno',	type:'output',  width:'8%', style: 'text-align:center;'},
            {caption: ["반품번호"],	ref: 'vhclno',		type:'output',  width:'8%', style: 'text-align:center;'},
            ...
            {caption: ["반품사유"],	ref: 'vhclno',		type:'output',  width:'31%', style: 'text-align:center;'},
        ]
