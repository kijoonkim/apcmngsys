...
<script type="application/javascript">
    ...
    const fn_create_rtnCrtr = async function(){
        ...
        SBGridProperties.columns = [
            ...
            {caption: ["거래처"],	ref: 'wghno',	type:'output',  width:'13%', style: 'text-align:center;'},
            {caption: ["출하번호"],	ref: 'vhclno',		type:'output',  width:'13%', style: 'text-align:center;'},
            {caption: ["출하정보"],	ref: 'vhclno',		type:'output',  width:'13%', style: 'text-align:center;'},
    ...
    const fn_create_rtnCrtrDtl = async function(){
        ...
        SBGridProperties.columns = [
            ...
            {caption: ["거래처"],	ref: 'wghno',	type:'output',  width:'10%', style: 'text-align:center;'},
