...
<script type="application/javascript">
    ...
    const fn_initSBSelect = async function() {
        ...
        jsonShpgot = jsonShpgot.map(item => {
            return {
                ...item,
                label: jsonShpgotCrtrType.filter(it => {
                    return it.cdVl === item.shpgotCrtrType
                })[0].cdVlNm,
                value: item.crtrCd
            }
        });
        ...
        SBGridProperties.columns = [
            {caption: ["출하일자"],	ref: 'spmtYmd',		type:'output',  width:'10%', style: 'text-align:center;'},
            {caption: ["배송사"],	ref: 'trsprtCoNm',		type:'output',  width:'10%', style: 'text-align:center;'},
            ...
            {caption: ["출하번호"],	ref: 'spmtno',		type:'output',  width:'15%', style: 'text-align:center;'},
            {caption: ["상품명"],	ref: 'gdsNm',		type:'output',  width:'15%', style: 'text-align:center;'},
            {caption: ["수량"],	ref: 'spmtQntt',		type:'output',  width:'10%', style: 'text-align:center;'},
            {caption: ["중량"],	ref: 'spmtWght',		type:'output',  width:'10%', style: 'text-align:center;'},
        ]
    ...
    const fn_create_rtnCrtrDtl = async function(){
        ...
        SBGridProperties.columns = [
            ...
            {caption: ["품종"],	ref: 'vrtyNm',		type:'output',  width:'10%', style: 'text-align:center;'},
            {caption: ["거래처"],	ref: 'cnptNm',	type:'output',  width:'10%', style: 'text-align:center;'},
            {caption: ["출하번호"],	ref: 'spmtno',		type:'output',  width:'10%', style: 'text-align:center;'},
            ...
            {caption: ["상세코드"],	ref: 'dtlSn',		type:'input',  width:'10%', style: 'text-align:center;background-color:#FFF8DC'},
            {caption: ["반품사유"],	ref: 'shpgotRmrk',		type:'input',  width:'25%', style: 'text-align:center;'},
        ]
    ...
    const fn_search = async function(){
        ...
        const postJsonPromise = gfn_postJSON("/am/spmt/selectSpmtPrfmncList.do",searchParam);
    ...
    const fn_addRow = async function(nRow){
        ...
        editableRow.spmtno = tData.spmtno;
        editableRow.cnptNm = tData.cnptNm;
