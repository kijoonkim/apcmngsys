			...
			<div class="box-header">
				<div class="ad_tbl_top">
					<div class="ad_tbl_toplist">
						...
						<sbux-button id="btnEndItem" name="btnEndItem" uitype="normal" text="종료" class="btn btn-sm btn-outline-danger" onclick="fn_closeModal('modal-itemCrtr')">종료</sbux-button>
					</div>
				</div>
			</div>
