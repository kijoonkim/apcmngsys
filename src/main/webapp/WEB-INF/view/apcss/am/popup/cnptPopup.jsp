			...
			<div class="box-header">
				<div class="ad_tbl_top">
					<div class="ad_tbl_toplist">
						<sbux-button id="btnSearchCnpt" name="btnSearchCnpt" uitype="button" class="btn btn-sm btn-outline-danger" onclick="fn_searchCnpt">조회</sbux-button>
						<sbux-button id="btnEndCnpt" name="btnEndCnpt" uitype="button" class="btn btn-sm btn-outline-danger" onclick="fn_closeModal('modal-cnpt')">종료</sbux-button>
					</div>
				</div>
			</div>
