	...
	const popWrhsPltBx = {
			...
			createGrid: function() {
			    ...
			    SBGridProperties.columns = [
			    	...
			    	{caption: ["팔레트","종류"],	ref: 'pltKnd',		type:'combo',  width:'100px',   style:'text-align:center;background-color:#FFF8DC;',
						typeinfo : {
			    	...
			    	{caption: ["팔레트","팔레트번호"], ref: 'pltno',  	type:'input',  width:'80px',    style:'text-align:right;',
			    		maxlength: 14,
			        ...
			        {caption: ["팔레트","중량"], 	ref: 'pltWght',   		type:'output',  width:'50px',   style:'text-align:right',
		    		...
		    		{caption: ["박스","단중"], 		ref: 'bxUnitWght',   	type:'output',  width:'50px',   style:'text-align:right',
			        	format : {type:'number', rule:'#,###'},
			        	datatype: 'number',
			        },
		    		{caption: ["박스","중량"], 		ref: 'bxWght',   	type:'output',  width:'50px',   style:'text-align:right',
			        	format : {type:'number', rule:'#,###'},
			        	datatype: 'number',
			        },
			    ];
