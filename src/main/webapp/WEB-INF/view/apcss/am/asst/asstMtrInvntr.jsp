...
<%
/**
 * @Class Name : asstInvntr.jsp
 * @Description : 부자재 현황 조회
 * @author SI개발부
 * @since 2024.09.03
 * @version 1.0
				...
				<div>
						...
						<tbody>
							<tr>
								...
								<td colspan="2" class="td_input" style="border-right: hidden;"><sbux-select
										id="srch-slt-asstMtrTypeDtl" name="srch-slt-asstMtrTypeDtl"
										uitype="single" class="form-control input-sm"
										unselected-text="전체" jsondata-ref="jsonAsstMtrTypeDtl"></sbux-select>
								</td>
							</tr>
							<tr>
								<th scope="row" class="th_bg">조회구분</th>
								<td class="td_input" style="border-right: hidden;"><sbux-select
										id="srch-slt-srchSe" name="srch-slt-srchSe"
										uitype="single" class="form-control input-sm"
										unselected-text="전체" jsondata-ref="jsonSrchSe"></sbux-select>
								</td>
					...
					<div style="display: flex; gap: 3vw">
						<div style="flex: 1; display: flex; flex-direction: column;">
							<div class="ad_tbl_top">
								<ul class="ad_tbl_count">
									<li><span>부자재 입고 목록</span></li>
								</ul>
							</div>
							<div id="sb-area-grdAsstMtrWrhs" style="flex: 1"></div>
						</div>
					</div>
					<div style="display: flex; gap: 3vw">
						<div style="flex: 1; display: flex; flex-direction: column;">
							<div class="ad_tbl_top">
								<ul class="ad_tbl_count">
									<li><span>부자재 출고 목록</span></li>
								</ul>
							</div>
							<div id="sb-area-grdAsstMtrSpmt" style="flex: 1"></div>
						</div>
					</div>
				</div>
			</div>
