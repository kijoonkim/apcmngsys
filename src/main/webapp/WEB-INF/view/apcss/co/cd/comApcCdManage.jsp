...
<script type="text/javascript">
    ...
    function fn_comCdCreateGrid() {
        ...
        SBGridProperties.columns = [        	
            {caption: ["코드ID"],		ref: 'cdId',	type: 'output',		width: '150px',	style: 'text-align:center',
            	validate : gfn_chkByte.bind({byteLimit: 20}),  disabled: true},
            {caption: ["코드명"],		ref: 'cdNm',	type: 'output',		width: '150px',	style: 'text-align:center',
            	validate : gfn_chkByte.bind({byteLimit: 100}),  disabled: true},
            {caption: ["코드유형"],	ref: 'cdType',	type: 'combo',		width: '150px',	style: 'text-align:center',
            	typeinfo: {ref:'jsonComCdType', itemcount: 10, label:'label', value:'value'},  disabled: true},
            {caption: ["코드설명"],	ref: 'cdExpln',	type: 'output',		width: '200px',	style: 'text-align:center',
            	validate : gfn_chkByte.bind({byteLimit: 1000}),  disabled: true}
        ];
    ...
    function fn_comCdDtlCreateGrid() {
        ...
        SBGridProperties.columns = [
            ...
            {caption: ["코드값"],		ref: 'cdVl',		type: 'input',		width: '70px',	style: 'text-align:center',
           	...
           	{caption: ["APC코드"],	ref: 'apcCd',		type: 'input',		width: '100px',	style: 'text-align:center',
           		validate : gfn_chkByte.bind({byteLimit: 4})	},
          	{caption: ["APC명"],	ref: 'apcNm',		type: 'input',		width: '100px',	style: 'text-align:center',
          		validate : gfn_chkByte.bind({byteLimit: 40}),  disabled: true},
