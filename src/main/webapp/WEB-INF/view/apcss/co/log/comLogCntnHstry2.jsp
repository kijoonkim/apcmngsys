			...
			<div class="box-body">
				...
				<div class="ad_tbl_top2">
					<div class="ad_tbl_toplist">
						<sbux-button id="btnLogCntnHstry" name="btnLogCntnHstry" uitype="normal" text="접속이력" class="btn btn-sm btn-outline-danger"></sbux-button>
						<sbux-button id="btnLogMenuHstry" name="btnLogMenuHstry" uitype="normal" text="화면열람이력" class="btn btn-sm btn-outline-danger"></sbux-button>
						<sbux-button id="btnLogTrsmHstry" name="btnLogTrsmHstry" uitype="normal" text="송수신이력" class="btn btn-sm btn-outline-danger"></sbux-button>
						<sbux-button id="btnLogBatchHstry" name="btnLogBatchHstry" uitype="normal" text="배치실행이력" class="btn btn-sm btn-outline-danger"></sbux-button>
					</div>
				</div>
				<div id = "tab_content">
