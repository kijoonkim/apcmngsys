								...
								<table class="table table-bordered table-hover tbl_col tbl_fixed" >
									...
									<tbody>
										<tr>
											...
											<td><button type="button" class="btn btn-xs btn-outline-primary">btn1</button></td>
											<td><button type="button" class="btn btn-sm btn-outline-primary">btn2</button></td>
											<td><button type="button" class="btn btn-md btn-outline-primary">btn3</button></td>
											<td><button type="button" class="btn btn-lg btn-outline-primary">btn4</button></td>
											<td>
											<button type="button" class="btn btn-xs btn-outline-primary">삭제5</button>
											</td>
										</tr>
										<tr>
											<td>&nbsp;</td>
											...
											<td><button type="button" class="btn btn-xs btn-outline-primary">저장함1</button></td>
											<td><button type="button" class="btn btn-xs btn-outline-primary">수정함2</button></td>
											<td><button type="button" class="btn btn-xs btn-outline-primary">변경함3</button></td>
											<td><button type="button" class="btn btn-xs btn-outline-primary">등록함4</button></td>
											<td><button type="button" class="btn btn-xs btn-outline-primary">조회함5</button></td>
										</tr>
										<tr>
											<td>&nbsp;</td>
											<td>&nbsp;</td>
