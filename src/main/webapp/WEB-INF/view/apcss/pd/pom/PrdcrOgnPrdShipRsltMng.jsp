				...
				<table class="table table-bordered tbl_fixed">
					...
					<tbody>
						<tr>
							...
							<td colspan="2" class="td_input">
								<sbux-select
									id="srch-input-trmtType"
									name="srch-input-trmtType"
									uitype="single"
									jsondata-ref="selectTrmtType"
									unselected-text="전체"
									class="form-control input-sm"
								></sbux-select>
							</td>
...
//조직 선택후 품목 취급유형 선택후 다시 조회
	...
	//출자출하조직 보유 여부
	var selectTrmtType = [
		{'text': '수탁','label': '수탁', 'value': '1'},
		{'text': '매취','label': '매취', 'value': '2'}
	];
	...
	const fn_fcltMngCreateGrid01 = async function() {
	    ...
	    SBGridProperties.columns = [
	    	...
	    	{caption: ["조직원명"], 		ref: 'prdcrOgnzNm',   	type:'input',  width:'120px',    style:'text-align:center'},
	        {caption: ["조직원 코드"], 	ref: 'prdcrOgnzCd',   	type:'input',  width:'150px',    style:'text-align:center'},
	        {caption: ["품종"], 			ref: 'itemCd',   		type:'input',  width:'120px',    style:'text-align:center'},
	        {caption: ["재배면적(㎡)"], 	ref: 'cltvtnArea',   	type:'input',  width:'120px',    style:'text-align:center'},
	        {caption: ["생산량(결과)(톤)"], 	ref: 'prdctnVlm',   type:'input',  width:'120px',    style:'text-align:center'},
	        {caption: ["전속출하량(결과)(톤)"], ref: 'ecSpmtVlm',   type:'input',  width:'120px',    style:'text-align:center'},
	        {caption: ["출하대금 지급액(천원)"], ref: 'spmtPrc',   type:'input',  width:'130px',    style:'text-align:center'},
	        {caption: ["가입일"], 		ref: 'joinDay',  		type:'input',  width:'100px',    style:'text-align:center'},
	        {caption: ["탈퇴일"], 		ref: 'whdwlDay',  		type:'input',  width:'100px',    style:'text-align:center'},
	        {caption: ["비고"], 			ref: 'spmtRmrk',   			type:'input',  width:'180px',    style:'text-align:center'},
	...
	async function fn_dtlGridSearch() {
		...
		let postJsonPromise01 = gfn_postJSON("/pd/pom/selectPrdcrOgnCurntMngDtlList.do", {
			apoCd : apoCd
    		,itemCd : itemCd
    		,trmtType : trmtType
		});
