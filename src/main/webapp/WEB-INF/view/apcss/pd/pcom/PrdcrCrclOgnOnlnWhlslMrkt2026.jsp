<%
    /**
     * @Class Name : PrdcrCrclOgnOnlnWhlslMrkt2026.jsp
     * @Description : 온라인도매시장판매목표 2026
     * @author SI개발부
     * @since 2025.11.15
     * @version 1.0
    ...
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            <div class="ad_section_top" id="grid3">
                ...
                <div id="pruoPrgrsSttsSpmtPrfmnc" style="border:1px solid #red; background-color: #ffc0cb; border-radius: 10px; padding: 10px; display: none; max-height: 200px; overflow: auto;">
                    <sbux-label id="dtl-inp-pruoPrgrsSttsSpmt" name="dtl-inp-pruoPrgrsSttsSpmt" uitype="normal" style="font-weight: bold"></sbux-label>
                </div>
            ...
            <div id="pruoPrgrsSttsNtslTrgt" style="border:1px solid #red; background-color: #ffc0cb; border-radius: 10px; padding: 10px; display: none; max-height: 200px; overflow: auto;">
                <sbux-label id="dtl-inp-pruoPrgrsSttsNtsl" name="dtl-inp-pruoPrgrsSttsNtsl" uitype="normal" style="font-weight: bold"></sbux-label>
            </div>
...
<script type="text/javascript">
    ...
    const fn_setYear = async function() {
        ...
        SBUxMethod.set("dtl-input-yr","2026");
        $(".setYr").text(year);
    }
    ...
    const fn_search = async function(){
        ...
        const pruoPrgrsSttsMaster = await gfn_chkPruoPrgrsStts(yr, apoCd, "PD_006_006");
        fn_pruoPrgrsStts(pruoPrgrsSttsMaster, "pruoPrgrsSttsMasterArea", "dtl-inp-pruoPrgrsStts");

        const pruoPrgrsSttSpmt = await gfn_chkPruoPrgrsStts(yr, apoCd, "PD_006_006_01");
        fn_pruoPrgrsStts(pruoPrgrsSttSpmt, "pruoPrgrsSttsSpmtPrfmnc", "dtl-inp-pruoPrgrsSttsSpmt");

        const pruoPrgrsSttsNtslTrgt = await gfn_chkPruoPrgrsStts(yr, apoCd, "PD_006_006_02");
        fn_pruoPrgrsStts(pruoPrgrsSttsNtslTrgt, "pruoPrgrsSttsNtslTrgt", "dtl-inp-pruoPrgrsSttsNtsl");
    ...
    async function fn_save(){
        ...
        let yr = SBUxMethod.get('dtl-input-yr');
        const apoCd = SBUxMethod.get('dtl-input-apoCd'); // 조직 코드

        if (!gfn_comConfirm("Q0001", "판매목표 저장")) {	//	Q0001	{0} 하시겠습니까?
            return;
        }

        // let postJsonPromise = gfn_postJSON("/pd/pcom/insertPrdcrCrclOgnOnlnWhlslMrkt.do", {
        const postJsonPromise = gfn_postJSON("/pd/aom/insertWhlslMrktNtslTrgt.do", {
            brno : brno
            ,yr : yr
    ...
    async function fn_saveOnln(){
        ...
        const postJsonPromise = gfn_postJSON("/pd/aom/insertOnlnWhlslMrktSpmtPrfmnc.do", saveList);
    ...
    function fn_clearPruoPrgrsStts() {
        ...
        // pruoPrgrsSttsSpmtPrfmnc dtl-inp-pruoPrgrsSttsSpmt
        // pruoPrgrsSttsNtslTrgt dtl-inp-pruoPrgrsSttsNtsl

        document.getElementById('pruoPrgrsSttsMasterArea').style.display = 'none';
        document.getElementById('pruoPrgrsSttsSpmtPrfmnc').style.display = 'none';
        document.getElementById('pruoPrgrsSttsNtslTrgt').style.display = 'none';

        SBUxMethod.set('dtl-inp-pruoPrgrsStts',"");
        SBUxMethod.set('dtl-inp-pruoPrgrsSttsSpmt',"");
        SBUxMethod.set('dtl-inp-pruoPrgrsSttsNtsl',"");
    }
