...
//조직 선택후 품목 취급유형 선택후 다시 조회
	...
	const fn_fcltMngCreateGrid01 = async function() {
	    ...
	    SBGridProperties.columns = [
	        ...
	        {caption: ["수탁","물량"], 		ref: 'prchsTrstVlm',   	type:'input',  width:'150px',    style:'text-align:center'},
	        {caption: ["수탁","금액"], 		ref: 'prchsTrstAmt',   	type:'input',  width:'150px',    style:'text-align:center'},
	        {caption: ["매취","물량"], 		ref: 'prchsEmspapVlm',   type:'input',  width:'150px',    style:'text-align:center'},
	        {caption: ["매취","금액"], 		ref: 'prchsEmspapAmt',   type:'input',  width:'150px',    style:'text-align:center'},
	        {caption: ["합계","물량"], 		ref: 'totVlm',   		type:'input',  width:'150px',    style:'text-align:center'},
	        {caption: ["합계","금액"], 		ref: 'totAmt',   		type:'input',  width:'150px',    style:'text-align:center'},
	...
	const fn_fcltMngCreateGrid02 = async function() {
	    ...
	    SBGridProperties.columns = [
	    	{caption: ["품목","품목"], 		ref: 'itemNm',   	type:'output',  width:'80px',    style:'text-align:center'},
	    	{caption: ["품목분류","품목분류"], 	ref: 'ctgryNm',   	type:'output',  width:'150px',    style:'text-align:center'},
	        {caption: ["수탁","물량"], 		ref: 'slsEmspapVlm',   	type:'input',  width:'150px',    style:'text-align:center'},
	        {caption: ["수탁","금액"], 		ref: 'slsEmspapAmt',   	type:'input',  width:'150px',    style:'text-align:center'},
	        {caption: ["매취","물량"], 		ref: 'slsTrstVlm',   type:'input',  width:'150px',    style:'text-align:center'},
	        {caption: ["매취","금액"], 		ref: 'slsTrstAmt',   type:'input',  width:'150px',    style:'text-align:center'},
	        {caption: ["합계","물량"], 		ref: 'totVlm',   		type:'input',  width:'150px',    style:'text-align:center'},
	        {caption: ["합계","금액"], 		ref: 'totAmt',   		type:'input',  width:'150px',    style:'text-align:center'},
	        {caption: ["처리","처리"], 		ref: 'delYn',   		type:'button', width:'80px',    style:'text-align:center', renderer: function(objGrid, nRow, nCol, strValue, objRowData){
	        	if(strValue== null || strValue == ""){
