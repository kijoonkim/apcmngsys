...
//조직 선택후 품목 취급유형 선택후 다시 조회
	...
	const fn_fcltMngCreateGrid02 = async function() {
	    ...
	    SBGridProperties.columns = [
	        ...
	        {caption: ["단순수탁","물량"], 		ref: 'slsEmspapVlm',   	type:'input',  width:'90px',    style:'text-align:center'},
	        {caption: ["단순수탁","금액"], 		ref: 'slsEmspapAmt',   	type:'input',  width:'100px',    style:'text-align:center'},
	        {caption: ["단순매취","물량"], 		ref: 'slsTrstVlm',   type:'input',  width:'90px',    style:'text-align:center'},
	        {caption: ["단순매취","금액"], 		ref: 'slsTrstAmt',   type:'input',  width:'100px',    style:'text-align:center'},
