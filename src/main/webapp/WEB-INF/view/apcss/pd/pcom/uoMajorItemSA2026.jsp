...
<head>
  ...
  <title>title : 전문품목 매입·매출 (출자출하조직 미보유) 2026</title>
...
<script type="text/javascript">
  ...
  const fn_dtlGridSearch = async function(){
    ...
    const pruoPrgrsStts = await gfn_chkPruoPrgrsStts(yr, apoCd, "PD_006_004");
  ...
  const fn_listSave = async function(_tmprStrgYn){
    ...
    const postJsonPromise = gfn_postJSON("/pd/aom/insertPruoNtslDlgtSlsPrfmncIsoN.do", saveList);
    let data = await postJsonPromise;
    try {
