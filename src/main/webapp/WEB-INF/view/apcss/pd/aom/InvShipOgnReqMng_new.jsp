			...
			<div class = "uoGrid">
				...
				<div class="uoList">
					...
					<div style="border:1px solid #f4f4f4; background-color: #f4f4f4; border-radius: 10px; padding: 10px;">
						<p>- 통합조직이 신청을 완료했어야 출자출하조직이 선택가능(선택이 안되면, 통합조직에게 작성완료 여부를 우선 확인 필요)</p>
						<p>- 전문품목에 대해 판매위임하고 있는 통합조직명을 검색하여 등록 필요(복수 통합조직에게 판매위임하는 경우, 2개 이상의 통합조직 등록 가능) </p>
					</div>
					<!-- SBGrid를 호출합니다. -->
				...
				<div style="border:1px solid #f4f4f4; background-color: #f4f4f4; border-radius: 10px; padding: 10px;">
					<p>- 산지유통활성화자금 : 자금을 신청하고 배정받을 통합조직을 선택(복수출자출하조직의 경우 1개 통합조직 선택 필요)</p>
					<p>- 자금 신청액의 최소 단위는 100,000(천원)이고 이하 단위는 자동 절삭처리</p>
				</div>
