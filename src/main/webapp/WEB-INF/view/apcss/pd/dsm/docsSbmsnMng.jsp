		...
		<div class="box box-solid">
			...
			<div class="box-body">
				...
				<div class="ad_section_top">
					...
					<!-- SBGrid를 호출합니다. -->
					<div id="sb-area-grdUoAprv" style="height:300px; width: 100%;"></div>
				</div>
				<div class="ad_tbl_top">
					<ul class="ad_tbl_count">
						<li>
							<span style="font-size:14px">- 선택 통합조직</span>
						</li>
					</ul>
				</div>
				<table class="table table-bordered tbl_fixed">
				...
				<table class="table table-bordered tbl_fixed" style="border: none">
					<caption>제출 서류 리스트</caption>
						<col style="width: 3%; min-width: 35px;">
						<col style="width: 20%">
					...
					<tbody>
						<tr>
							<th scope="row" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-bscAllChk"
									name="dtl-inp-bscAllChk"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
									onclick="fn_allChkClick('BSC')"
									></sbux-checkbox>
							</th>
				...
				<div class="box-header" style="display:flex; justify-content: flex-start;" >
					<div style="margin-left: auto;">
						<sbux-button id="bscBtnAprvY" name="bscBtnAprvY" uitype="normal" text="선택 승인" class="btn btn-sm btn-outline-danger" onclick="fn_updateAprv('BSC','Y')"></sbux-button>
						<sbux-button id="bscBtnAprvC" name="bscBtnAprvC" uitype="normal" text="선택 취소" class="btn btn-sm btn-outline-danger" onclick="fn_updateAprv('BSC','C')"></sbux-button>
						<sbux-button id="bscBtnAprvN" name="bscBtnAprvN" uitype="normal" text="선택 반려" class="btn btn-sm btn-outline-danger" onclick="fn_updateAprv('BSC','N')"></sbux-button>
						<sbux-button id="bscBtnSave" name="bscBtnSave" uitype="normal" text="기본요건 서류 제출" class="btn btn-sm btn-outline-danger" onclick="fn_save('BSC')"></sbux-button>
					</div>
				</div>
				<br><hr>
				...
				<table class="table table-bordered tbl_fixed" style="border: none">
					...
					<tbody>
						<tr>
							<th scope="row" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlUoAllChk"
									name="dtl-inp-dtlUoAllChk"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
									onclick="fn_allChkClick('DTLU')"
									></sbux-checkbox>
							</th>
							<th scope="row" class="th_bg text-center">제출서류</th>
							<th scope="row" colspan="2" class="th_bg text-center">제출서류</th>
						...
						<tr>
							<th scope="row" rowspan="2" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlUoChk1"
									name="dtl-inp-dtlUoChk1"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
						...
						<tr>
							<th scope="row" rowspan="2" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlUoChk2"
									name="dtl-inp-dtlUoChk2"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
						...
						<tr>
							<th scope="row" rowspan="2" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlUoChk3"
									name="dtl-inp-dtlUoChk3"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
						...
						<tr>
							<th scope="row" rowspan="2" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlUoChk4"
									name="dtl-inp-dtlUoChk4"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
						...
						<tr>
							<th scope="row" rowspan="2" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlUoChk5"
									name="dtl-inp-dtlUoChk5"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
						...
						<tr>
							<th scope="row" rowspan="2" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlUoChk6"
									name="dtl-inp-dtlUoChk6"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
						...
						<tr>
							<th scope="row" rowspan="2" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlUoChk7"
									name="dtl-inp-dtlUoChk7"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
						...
						<tr>
							<th scope="row" rowspan="2" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlUoChk8"
									name="dtl-inp-dtlUoChk8"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
				...
				<div class="box-header" style="display:flex; justify-content: flex-start;" >
					<div style="margin-left: auto;">
						<sbux-button id="dtlUoBtnAprvY" name="dtlUoBtnAprvY" uitype="normal" text="선택 승인" class="btn btn-sm btn-outline-danger" onclick="fn_updateAprv('DTLU','Y')"></sbux-button>
						<sbux-button id="dtlUoBtnAprvC" name="dtlUoBtnAprvC" uitype="normal" text="선택 취소" class="btn btn-sm btn-outline-danger" onclick="fn_updateAprv('DTLU','C')"></sbux-button>
						<sbux-button id="dtlUoBtnAprvN" name="dtlUoBtnAprvN" uitype="normal" text="선택 반려" class="btn btn-sm btn-outline-danger" onclick="fn_updateAprv('DTLU','N')"></sbux-button>
						<sbux-button id="dtlUoBtnSave" name="dtlUoBtnSave" uitype="normal" text="세부요건 서류 통합조직 제출" class="btn btn-sm btn-outline-danger" onclick="fn_save('DTLU')"></sbux-button>
					</div>
				</div>
				<br><hr>
				...
				<table class="table table-bordered tbl_fixed" style="border: none">
					...
					<tbody>
						<tr>
							<th scope="row" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlIsoAllChk"
									name="dtl-inp-dtlIsoAllChk"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
									onclick="fn_allChkClick('DTLI')"
									></sbux-checkbox>
							</th>
							<th scope="row" class="th_bg text-center">제출서류</th>
							<th scope="row" colspan="2" class="th_bg text-center">제출서류</th>
						...
						<tr>
							<th scope="row" rowspan="2" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlIsoChk1"
									name="dtl-inp-dtlIsoChk1"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
						...
						<tr>
							<th scope="row" rowspan="2" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlIsoChk2"
									name="dtl-inp-dtlIsoChk2"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
						...
						<tr>
							<th scope="row" rowspan="2" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlIsoChk3"
									name="dtl-inp-dtlIsoChk3"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
						...
						<tr>
							<th scope="row" rowspan="2" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlIsoChk4"
									name="dtl-inp-dtlIsoChk4"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
						...
						<tr>
							<th scope="row" rowspan="2" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlIsoChk5"
									name="dtl-inp-dtlIsoChk5"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
				...
				<div class="box-header" style="display:flex; justify-content: flex-start;" >
					<div style="margin-left: auto;">
						<sbux-button id="dtlIsoBtnAprvY" name="dtlIsoBtnAprvY" uitype="normal" text="선택 승인" class="btn btn-sm btn-outline-danger" onclick="fn_updateAprv('DTLI','Y')"></sbux-button>
						<sbux-button id="dtlIsoBtnAprvC" name="dtlIsoBtnAprvC" uitype="normal" text="선택 취소" class="btn btn-sm btn-outline-danger" onclick="fn_updateAprv('DTLI','C')"></sbux-button>
						<sbux-button id="dtlIsoBtnAprvN" name="dtlIsoBtnAprvN" uitype="normal" text="선택 반려" class="btn btn-sm btn-outline-danger" onclick="fn_updateAprv('DTLI','N')"></sbux-button>
						<sbux-button id="dtlIsoBtnSave" name="dtlIsoBtnSave" uitype="normal" text="세부요건 서류 출자출하조직 제출" class="btn btn-sm btn-outline-danger" onclick="fn_save('DTLI')"></sbux-button>
					</div>
				</div>
				<br><hr>
				...
				<table class="table table-bordered tbl_fixed" style="border: none">
					...
					<tbody>
						<tr>
							<th scope="row" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlPoAllChk"
									name="dtl-inp-dtlPoAllChk"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
									onclick="fn_allChkClick('DTLP')"
									></sbux-checkbox>
							</th>
							<th scope="row" class="th_bg text-center">제출서류</th>
							<th scope="row" colspan="2" class="th_bg text-center">제출서류</th>
						...
						<tr>
							<th scope="row" rowspan="2" class="th_bg text-center">
								<sbux-checkbox
									id="dtl-inp-dtlPoChk1"
									name="dtl-inp-dtlPoChk1"
									uitype="normal"
									text=""
									true-value="Y"
									false-value="N"
				...
				<div class="box-header" style="display:flex; justify-content: flex-start;" >
					<div style="margin-left: auto;">
						<sbux-button id="dtlPoBtnAprvY" name="dtlPoBtnAprvY" uitype="normal" text="선택 승인" class="btn btn-sm btn-outline-danger" onclick="fn_updateAprv('DTLP','Y')"></sbux-button>
						<sbux-button id="dtlPoBtnAprvC" name="dtlPoBtnAprvC" uitype="normal" text="선택 취소" class="btn btn-sm btn-outline-danger" onclick="fn_updateAprv('DTLP','C')"></sbux-button>
						<sbux-button id="dtlPoBtnAprvN" name="dtlPoBtnAprvN" uitype="normal" text="선택 반려" class="btn btn-sm btn-outline-danger" onclick="fn_updateAprv('DTLP','N')"></sbux-button>
						<sbux-button id="dtlPoBtnSave" name="dtlPoBtnSave" uitype="normal" text="세부요건 서류 생산자조직 제출" class="btn btn-sm btn-outline-danger" onclick="fn_save('DTLP')"></sbux-button>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	const fn_init = async function() {
		...
		await fn_createGridUoAprv(); //통합조직 리스트
		await fn_createGridBscDocUoIso();//기본요건 리스트
		await fn_createGridDtlDocIso();//세부요건 출자출하조직 리스트
		await fn_CreateGridDtlDocPo();//세부요건 생산자조직 리스트

		await fn_search();//통합조직 리스트 조회
	}
	...
	/* Grid 화면 그리기 기능*/
	const fn_createGridUoAprv = async function() {
		...
		SBGridProperties.columns = [
			{caption: ["등록년도"],		ref: 'yr',			type:'output',	width:'9%',		minwidth : '60px',	style:'text-align:center'},
			{caption: ["선정년도"],		ref: 'slctnYr',		type:'output',	width:'9%',		minwidth : '60px',	style:'text-align:center'},
			{caption: ["통합조직여부"],	ref: 'aprvNm',		type:'output',	width:'9%',		minwidth : '60px',	style:'text-align:center'},
			{caption: ["법인명"],		ref: 'corpNm',		type:'output',	width:'20%',	minwidth : '250px',	style:'text-align:center'},
			{caption: ["사업자번호"],	ref: 'brno',		type:'output',	width:'13%',	minwidth : '90px',	style:'text-align:center'},
			{caption: ["품목리스트"],	ref: 'itemNmList',	type:'output',	width:'40%',	minwidth : '250px',	style:'text-align:center'},

			{caption: ["조직코드"],			ref: 'apoCd',	hidden : true},
			{caption: ["법인등록코드"],		ref: 'crno',	hidden : true},
			{caption: ["법인등록코드"],		ref: 'aprvNm',	hidden : true},
		];

		grdUoAprv = _SBGrid.create(SBGridProperties);

		//클릭 이벤트 바인드
		grdUoAprv.bind('click','fn_viewUo');
		grdUoAprv.bind('beforepagechanged', 'fn_pagingBbsList');
	}

	/**
     * 통합조직 리스트 클릭 이벤트
     */
	const fn_viewUo = async function() {
		//데이터가 존재하는 그리드 범위 확인
		...
		SBUxMethod.set('dtl-inp-corpNm',gfn_nvl(rowData.corpNm))//
		...
		if(!gfn_isEmpty(rowData.brno) && !gfn_isEmpty(rowData.yr)){
			fn_dtlsearch();
		}
	}
     ...
     * 통합조직 리스트 상세 초기화
     */
	const fn_clearUoForm = async function() {
		SBUxMethod.set('dtl-inp-yr',null)//
		SBUxMethod.set('dtl-inp-corpNm',null)//
		SBUxMethod.set('dtl-inp-brno',null)//
		SBUxMethod.set('dtl-inp-crno',null)//

		await fn_clearAllGrid();//서류 리스트 관련 그리드 전체 초기화
	...
	const fn_clearForm = async function(_dcmntKnd) {
		...
		//체크박스 초기화
		SBUxMethod.set('dtl-inp-'+seNm+'Chk'+sn , 'N');//
		for (var sn = 1; sn <= fileCnt; sn++) {
			SBUxMethod.set('dtl-inp-'+seNm+'Chk'+sn , 'N');//
		}
	}
	...
	const fn_search = async function() {
		// set pagination
		let pageSize = grdUoAprv.getPageSize();
		let pageNo = 1;
		//입력폼 초기화
		fn_clearForm();

		fn_searchUoList(pageSize, pageNo);
	}

	const fn_pagingBbsList = async function() {
		let recordCountPerPage = grdUoAprv.getPageSize();   		// 몇개의 데이터를 가져올지 설정
		let currentPageNo = grdUoAprv.getSelectPageIndex(); 		// 몇번째 인덱스 부터 데이터를 가져올지 설정
		fn_searchUoList(recordCountPerPage, currentPageNo);
	}

	/**
     * 승인형 조직 유저정보 리스트 조회
     */
	const fn_searchUoList = async function(pageSize, pageNo) {

		let yr = SBUxMethod.get('srch-inp-yr');

		let postJsonPromise = gfn_postJSON("/pd/dsm/selectDocsSbmsnUoAprvList.do", {
			yr : yr
		...
		try{
			...
			if (jsonUoAprv.length > 0) {
				if(grdUoAprv.getPageTotalCount() != totalRecordCount){	// TotalCount가 달라지면 rebuild, setPageTotalCount 해주는 부분입니다
					grdUoAprv.setPageTotalCount(totalRecordCount);		// 데이터의 총 건수를 'setPageTotalCount' 메소드에 setting
					grdUoAprv.rebuild();
				}else{
					grdUoAprv.refresh()
				}
			} else {
				grdUoAprv.setPageTotalCount(totalRecordCount);
				grdUoAprv.rebuild();
			}
	...
	const fn_dtlsearch = async function() {
		...
		//서류 리스트 조회
		await fn_searchFileList('DTLU' , brno);
	...
	const fn_updateAprv = async function(_dcmntKnd,_dcmntAprvSe) {

		if(gfn_isEmpty(_dcmntKnd)){
			alert('선택된 문서종류가 없습니다');
			return;
		}
		...
		for (var sn = 1; sn <= fileCnt; sn++) {
			let chk = $('#dtl\\-inp\\-'+seNm+'Chk'+sn).val();//
			if(chk == 'Y'){
				let chkItem = {
						dcmntKnd	: _dcmntKnd
						,dcmntAprvSe: _dcmntAprvSe
						,yr			:yr
						,uoBrno		:uoBrno
						,brno		:brno
				...
				saveList.push(chkItem);
			}
		}

		if(saveList.length == 0){
			alert('승인할 파일을 선택해주세요');
			return;
		}

		const postJsonPromise = gfn_postJSON("/pd/dsm/multiSaveDocsSbmsnAprv.do", saveList);
	...
	const fn_allChkClick = async function(_dcmntKnd) {
		// 문서 종류에 따른 설정 가져오기
		const { fileCnt, seNm } = documentSettings[_dcmntKnd] || defaultSettings;
