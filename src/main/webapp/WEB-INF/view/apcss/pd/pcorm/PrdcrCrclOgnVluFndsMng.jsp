...
<script type="text/javascript">
	...
	const fn_createWghPrfmncGrid = function() {
        ...
        SBGridProperties.columns = [
            {caption: ['아이디'], ref: 'wghno', width: '100px', type: 'output', style:'text-align:center'},
        	{caption: ['이름'], ref: 'prdcrNm', width: '150px', type: 'output', style:'text-align:center'},
            {caption: ['법인명'], ref: 'itemNm', width: '150px', type: 'output', style:'text-align:center'},
            {caption: ['관할기관'], ref: 'vrtyNm', width: '150px', type: 'output', style:'text-align:center'},
            {caption: ['agrix승인'], ref: 'gdsSeNm', width: '250px', type: 'output', style:'text-align:center'},
            {caption: ['유통공사승인'], ref: 'wrhsSeNm', width: '250px', type: 'output', style:'text-align:center'},
            {caption: ['권한'], ref: 'trsprtSeNm', width: '200px', type: 'output', style:'text-align:center'},
            {caption: ['사업자번호'], ref: 'vhclno', width: '250px', type: 'output', style:'text-align:center'},
            ...
            {caption: ['비고'], 	ref: 'rmrk', width: '315px', type: 'output'},
