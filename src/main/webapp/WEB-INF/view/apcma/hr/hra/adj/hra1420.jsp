...
<script type="text/javascript">
    ...
    const fn_initSBSelect = async function() {
        let rst = await Promise.all([
            ...
            gfnma_setComSelect(['SRCH_EMP_STATE','gvwInfoGrid'], jsonSrchEmpState, 'L_HRI009', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
    ...
    var fn_compopup3 = function(row, col) {
        ...
        compopup1({
            ...
            ,itemSelectEvent		: function (data){
                //그리드내 원하는 위치에 값 셋팅하기
                gvwInfoGrid.setCellData(row, (col-4), data['DEPT_CD']);
                gvwInfoGrid.setCellData(row, (col-3), data['DEPT_NM']);
                gvwInfoGrid.setCellData(row, (col-2), data['EMP_CD']);
                gvwInfoGrid.setCellData(row, (col-1), data['EMP_NM']);
            }
        });
    }
            ...
            if (_.isEqual("S", data.resultStatus)) {
                ...
                data.cv_1.forEach((item, index) => {
                    const msg = {
                        ...
                        ,ANNUAL_SALARY_AMT 			         : gfn_nvl(item.ANNL_SLRY_AMT)
