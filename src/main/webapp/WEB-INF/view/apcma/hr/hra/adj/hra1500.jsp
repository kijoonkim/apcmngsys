...
<script type="text/javascript">
    ...
    function fn_createGrid() {
        ...
        SBGridProperties.columns = [
            ...
            {caption : ["계산상태"], ref : 'CALC_STATUS', width : '200px', style : 'text-align:center', type : 'combo', disabled: true,
                typeinfo : {ref : 'jsonCalcStatus',  label : 'label', value : 'value'}
            },
            ...
            {caption: ["표준세액공제 적용"], ref: 'STD_TX_DED_YN', type: 'checkbox', width: '200px', style: 'text-align:center',
                typeinfo: { ignoreupdate: true, fixedcellcheckbox: { usemode: true, rowindex: 0, deletecaption: false},
                    checkedvalue: 'Y', uncheckedvalue: 'N'
                }
            },
            {caption: ["표준세액공제 적용 결과"], ref: 'CALC_INC_TX_AMT_STD_APPLY', type: 'output', width: '250px', style: 'text-align:right'
                , typeinfo : { mask : {alias : 'numeric', unmaskvalue : false}/*, maxlength : 10*/},  format : { type:'number' , rule:'#,###', emptyvalue:'0' }},
            {caption: ["표준세액공제 미적용 결과"], ref: 'CALC_INC_TX_AMT_STD_NOAPY', type: 'output', width: '250px', style: 'text-align:right'
                , typeinfo : { mask : {alias : 'numeric', unmaskvalue : false}/*, maxlength : 10*/},  format : { type:'number' , rule:'#,###', emptyvalue:'0' }},
