    ...
    <div class="box box-solid">
        ...
        <div class="box-search-ma">
            ...
            <table id="dataArea1" class="table table-bordered tbl_fixed table-search-ma">
                ...
                <tbody>
                <tr>
                    <th scope="row" class="th_bg_search로">정산연도</th>
                    ...
                    <th scope="row" class="th_bg_search로">사업장</th>
                    ...
                    <th scope="row" class="th_bg_search로">급여영역</th>
                    ...
                    <td style="border-right: hidden;"></td>
                    <th scope="row" class="th_bg_search로">부서</th>
                ...
                <tr>
                    <th scope="row" class="th_bg_search로">사원</th>
                ...
                <tr>
                    <th scope="row" class="th_bg_search로">입사일</th>
                    <td class="td_input" style="border-right: hidden;">
                        <sbux-datepicker
                                id="SRCH_DATE_FR"
                                name="SRCH_DATE_FR"
                    ...
                    <td style="border-right: hidden;"></td>
                    <th scope="row" class="th_bg_search로">퇴사일</th>
                    <td class="td_input" style="border-right: hidden;">
                        <sbux-datepicker
                                id="SRCH_RET_DATE_FR"
...
<script type="text/javascript">
    ...
    const fn_initSBSelect = async function() {
        let rst = await Promise.all([
            ...
            gfnma_setComSelect(['gvwWorkComGrid','gvwWorkComGrid'], jsonWorkCompanyType, 'L_HRA031', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
    ...
    var fn_compopup3 = function(row, col) {
        ...
        var strWhereClause = "AND b.TX_TXFR_CD LIKE '%" + replaceText0 + "%' AND b.TX_TXFR_NM LIKE '%" + replaceText1 + "%'";
        ...
        compopup1({
            ...
            ,itemSelectEvent		: function (data){
                //그리드내 원하는 위치에 값 셋팅하기
                gvwTaxFreeGrid.setCellData(row, gvwTaxFreeGrid.getColRef('PREV_COM_NUM'), data['TX_TXFR_CD']); //비과세코드
                gvwTaxFreeGrid.setCellData(row, gvwTaxFreeGrid.getColRef('TAX_FREE_NAME'), data['TX_TXFR_NM']); //비과세약칭
    ...
    function fn_createGrid() {
        ...
        SBGridProperties.columns = [
            ...
            {caption : ["부서코드"], ref : 'DEPT_CODE', width : '140px', style : 'text-align:center', type : 'combo', disabled: true,
                typeinfo : {ref : 'jsonDeptCode',  label : 'label', value : 'value'}
            },
            ...
            {caption: ['입사일자'], ref: 'ENTER_DATE', width:'140px',	type: 'inputdate', style: 'text-align: center', sortable: false,
                ...
                if (_.isEqual("S", data.resultStatus)) {
                    ...
                    data.cv_2.forEach((item, index) => {
                        const msg = {
                            ...
                            PREV_COM_NAME           : gfn_nvl(item.PAST_PWOK_NM),
                            PREV_COM_NUM            : gfn_nvl(item.PAST_PWOK_BRNO),
                    ...
                    data.cv_3.forEach((item, index) => {
                        const msg = {
                            ...
                            TAX_FREE_NAME       : gfn_nvl(item.TX_TXFR_NM),
