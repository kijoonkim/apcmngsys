        ...
        <div class="box-body">
            <div class="box-search-ma">
                ...
                <tr>
                    ...
                    <td></td>
                    <th scope="row" class="th_bg_search"><span class="data_required"></span>재직구분</th>
                    <td colspan="3" class="td_input" style="border-right:hidden;">
