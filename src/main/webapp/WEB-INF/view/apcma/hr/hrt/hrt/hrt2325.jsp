        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <div class="table-responsive tbl_scroll_sm">
                        <div id="sb-area-bandgvwInfo" style="height:530px;"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                if (bandgvwInfo.getCellData(nRow,bandgvwInfo.getColRef("SHIFT_CODE")) != "") {
                    ...
                    try {
                        if (_.isEqual("S", data.resultStatus)) {
                            ...
                            bEventEnabled = false;
                            bandgvwInfo.setCellData(nRow, bandgvwInfo.getColRef("START_DAY_TYPE"), gfn_nvl(returnData["BGNG_DAY_TYPE"]));
                            bandgvwInfo.setCellData(nRow, bandgvwInfo.getColRef("TIME_START_HHMM"), gfn_nvl(returnData["WRKDY_BGNG_HM"]));
                            bandgvwInfo.setCellData(nRow, bandgvwInfo.getColRef("END_DAY_TYPE"), gfn_nvl(returnData["END_DAY_TYPE"]));
                            bandgvwInfo.setCellData(nRow, bandgvwInfo.getColRef("TIME_END_HHMM"), gfn_nvl(returnData["END_TM"]));
                            bandgvwInfo.setCellData(nRow, bandgvwInfo.getColRef("WORK_DAY_TYPE"), gfn_nvl(returnData["WORK_DAY_TYPE"]));
                            bandgvwInfo.setCellData(nRow, bandgvwInfo.getColRef("TIME_ITEM_CODE"), gfn_nvl(returnData["ATDNC_ITEM_CD"]));
