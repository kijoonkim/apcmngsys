...
<script type="text/javascript">
    ...
    function fn_createGvwPatternGrid() {
        ...
        SBGridProperties.columns = [
            ...
            {caption: ["근무패턴"], 		ref: 'WORK_PATTERN_CODE',   	    type:'combo', style:'text-align:center' ,width: '140px',
                typeinfo: {
        ...
        updatedEmpData.forEach((item, index) => {
            ...
            const param = {
                ...
                params: gfnma_objectToString({
                    ...
                    V_P_WORK_PATTERN_CODE : gfn_nvl(item.data.WORK_PATTERN_CODE),
                    V_P_POSITION_CODE : gfn_nvl(item.data.POSITION_CODE),
                    V_P_DUTY_CODE : gfn_nvl(item.data.DUTY_CODE),
                    V_P_JOB_RANK : gfn_nvl(item.data.JOB_RANK),
                    V_P_FORM_ID : p_formId,
                    V_P_MENU_ID : p_menuId,
                    V_P_PROC_ID : '',
                    V_P_USERID : '',
