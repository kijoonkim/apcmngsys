...
<script type="text/javascript">
    ...
    const fn_search = async function () {
        let SUMMARY_SCALE = gfn_nvl(gfnma_multiSelectGet('#SRCH_SUMMARY_SCALE'));
        let TIME_CATEGORY = gfn_nvl(SBUxMethod.get("SRCH_TIME_CATEGORY"));
        let TIME_ITEM_CODE = gfn_nvl(SBUxMethod.get("SRCH_TIME_ITEM_CODE"));
        let TIME_ITEM_NAME = gfn_nvl(SBUxMethod.get("SRCH_TIME_ITEM_NAME"));
        ...
        updatedData.forEach((item, index) => {
            const param = {
                ...
                params: gfnma_objectToString({
                    ...
                    V_P_TIME_ITEM_ABBR_NAME : gfn_nvl(item.data.TIME_ITEM_ABBR_NAME),
                    V_P_SUMMARY_SCALE : gfn_nvl(item.data.SUMMARY_SCALE),
                    V_P_SUMMARY_CODE_TIME : gfn_nvl(item.data.SUMMARY_CODE_TIME),
                    V_P_SUMMARY_CODE_COUNT : gfn_nvl(item.data.SUMMARY_CODE_COUNT),
                    V_P_ADJUST_WORK_DAY : gfn_nvl(item.data.ADJUST_WORK_DAY),
                    V_P_ADJUST_REAL_WORK_DAY : gfn_nvl(item.data.ADJUST_REAL_WORK_DAY),
                    V_P_ADJUST_ANNUAL_DAY : gfn_nvl(item.data.ADJUST_ANNUAL_DAY),
                    V_P_VACATION_DAY : gfn_nvl(item.data.VACATION_DAY),
                    V_P_PAID_DAY : gfn_nvl(item.data.PAID_DAY),
                    V_P_UNPAID_DAY : gfn_nvl(item.data.UNPAID_DAY),
                    V_P_BASE_WORK_DAY : gfn_nvl(item.data.BASE_WORK_DAY),
                    V_P_REAL_WORK_DAY : gfn_nvl(item.data.REAL_WORK_DAY),
                    V_P_ANNUAL_DAY : gfn_nvl(item.data.ANNUAL_DAY),
                    V_P_MEMO : gfn_nvl(item.data.MEMO),
                    V_P_USE_YN : gfn_nvl(item.data.USE_YN),
                    V_P_INPUT_YN : gfn_nvl(item.data.INPUT_YN),
                    V_P_PLAN_YN : gfn_nvl(item.data.PLAN_YN),
                    V_P_BASE_RULE : gfn_nvl(item.data.BASE_RULE),
                    V_P_WORKER_YN : gfn_nvl(item.data.WORKER_YN),
                    V_P_GENERAL_YN : gfn_nvl(item.data.GENERAL_YN),
                    V_P_START_DAY_TYPE : gfn_nvl(item.data.START_DAY_TYPE),
                    V_P_START_HHMM : gfn_nvl(item.data.START_HHMM),
                    V_P_END_DAY_TYPE : gfn_nvl(item.data.END_DAY_TYPE),
                    V_P_END_HHMM : gfn_nvl(item.data.END_HHMM),
                    V_P_TIME_CATEGORY : gfn_nvl(item.data.TIME_CATEGORY),
                    V_P_PAID_YN : gfn_nvl(item.data.PAID_YN),
                    V_P_ESS_YN : gfn_nvl(item.data.ESS_YN),
                    V_P_SUMMARY_ITEM_CODE : gfn_nvl(item.data.SUMMARY_ITEM_CODE),
                    V_P_TIME52_YN : gfn_nvl(item.data.TIME52_YN),
                    V_P_OVERTIME_YN : gfn_nvl(item.data.OVERTIME_YN),
                    V_P_EXCEPT_YN : gfn_nvl(item.data.EXCEPT_YN),
                    V_P_NIGHT_TIME_YN : gfn_nvl(item.data.NIGHT_TIME_YN),
                    V_P_RESULT_YN : gfn_nvl(item.data.RESULT_YN),
                    V_P_ALTER_WORK_YN : gfn_nvl(item.data.ALTER_WORK_YN),
                    V_P_ALTER_REQ_YN : gfn_nvl(item.data.ALTER_REQ_YN),
                    V_P_SHIFT_WORK_YN : gfn_nvl(item.data.SHIFT_WORK_YN),
                    V_P_FORM_ID: p_formId,
                    V_P_MENU_ID: p_menuId,
                    V_P_PROC_ID: '',
                    V_P_USERID: '',
