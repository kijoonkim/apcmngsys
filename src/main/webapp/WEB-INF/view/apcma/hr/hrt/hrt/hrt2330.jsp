            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <div class="table-responsive tbl_scroll_sm">
                        <div id="sb-area-gvwShift" style="height:530px;"></div>
                    </div>
                </div>
                <div class="col-sm-8">
                    <div class="ad_tbl_top">
                    ...
                    <div class="table-responsive tbl_scroll_sm">
                        <div id="sb-area-gvwDetail" style="height:530px;"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    const fn_initSBSelect = async function() {
        let rst = await Promise.all([
            ...
            // 직위
            gfnma_setComSelect(['gvwShift', 'gvwDetail'], jsonPositionCode, 'L_HRI002', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            // 교대조
            ...
            // 휴일여부
            gfnma_setComSelect(['gvwDetail'], jsonHolidayYn, 'L_HRT015', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            // 근무일구분
            gfnma_setComSelect(['gvwDetail'], jsonWorkDayType, 'L_HRT019', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            // 구분
            gfnma_setComSelect(['gvwDetail'], jsonTimeCategory, 'L_HRT024_05', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            // 근태항목
            ...
            // 시작/종료일자유형
            gfnma_setComSelect(['gvwDetail'], jsonStartEndDayType, 'L_HRT011', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            // 상태
            ...
            if (_.isEqual("S", listData.resultStatus)) {
                ...
                if(listData.cv_3.length > 0) {
                    ...
                    listData.cv_3.forEach((item, index) => {
                        let nCol = gvwDetail.getColRef(item.ATDNC_ARTCL_NM.toUpperCase());
 
                        if (item.USE_YN == "Y") {
                            gvwDetail.setColHidden(nCol, false, false);
                            gvwDetailCaptionList[nCol] = item.ATDNC_TOT_NM;
                        } else {
