        ...
        updatedData.forEach((item, index) => {
            const param = {
                ...
                params: gfnma_objectToString({
                    ...
                    V_P_TXN_ID                  : gfnma_nvl2(item.data.TXN_ID) == '' ? 0 : item.data.TXN_ID,
                    V_P_HISTORY_SEQ             : gfnma_nvl2(item.data.HISTORY_SEQ) == '' ? 0 : item.data.HISTORY_SEQ,
