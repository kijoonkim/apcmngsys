...
<script type="text/javascript">
    ...
    var tabJsonData = [
        { "id" : "0", "pid" : "-1", "order" : "1", "text" : "국민연금 내역 등록",     "targetid" : "tabInfo1" , "targetvalue" : "국민연금 내역 등록"},
        { "id" : "1", "pid" : "-1", "order" : "2", "text" : "국민연금 내역 조회",     "targetid" : "tabInfo2" , "targetvalue" : "국민연금 내역 조회"}
    ];
