            ...
            if (_.isEqual("S", data.resultStatus)) {
                ...
                data.cv_1.forEach((item, index) => {
                    const msg = {
                        ...
                        ACCIDENT_INCOME_AMOUNT  : gfn_nvl(item.IA_TSL_AMT),
                        INSURE_AMOUNT           : gfn_nvl(item.INSRNC_AMT),
                        CLR_INSURE_AMOUNT       : gfn_nvl(item.ADD_IA_INSRNC_AMT_DDC),
                        RECLR_INCOME_AMOUNT     : gfn_nvl(item.CLCLN_INCM_AMT),
                        RECLR_INSURE_AMOUNT     : gfn_nvl(item.CLCLN_ISPM),
