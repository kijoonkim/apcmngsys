                            ...
                            <table class="table table-bordered tbl_fixed">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="td_input">
                                        <sbux-select id="dtl-select-msgKnd" name="dtl-select-msgKnd" uitype="single" jsondata-ref="jsonComMsgKnd" unselected-text="선택" class="form-control input-sm"></sbux-select>
                                    </td>
                                </tr>
                                <tr>
