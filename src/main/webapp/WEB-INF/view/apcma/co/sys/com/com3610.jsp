        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
                ...
                <table class="table table-bordered tbl_fixed">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row" class="th_bg">관리항목코드</th>
                            ...
                            <td style="border-right: hidden;">&nbsp;</td>
                            <th scope="row" class="th_bg">관리항목명</th>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <div>
                            <div id="sb-area-grdCom3610" style="height:600px; width:100%;"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="ad_tbl_top2">
	                        <div>
	                            <div id="sb-area-subGrdCom3610" style="height:292px; width:100%;"></div>
	                        </div>
                        </div>
                    </div>
                </div>
