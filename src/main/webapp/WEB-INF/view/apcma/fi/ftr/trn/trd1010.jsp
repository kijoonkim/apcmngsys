        ...
        <div class="box-body">
            <div class="box-search-ma">
                ...
                <tr>
                    ...
                    <th scope="row" class="th_bg_search">계좌</th>
...
<script type="text/javascript">
    ...
    const fn_initSBSelect = async function() {
        let rst = await Promise.all([
            ...
            // 거래유형
            gfnma_setComSelect(['gvwList'], jsonTxnType, 'L_FIM082_DEPO', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            gfnma_multiSelectInit({
                ...
                ,colLabel		: 'CD_NM'
                ,columns		:[
                    {caption: "코드",		ref: 'SBSD_CD', 			width:'80px',  	style:'text-align:left'},
                    {caption: "명칭", 		ref: 'CD_NM',    		width:'120px',  	style:'text-align:left'},
                ]
            }),
            ...
            // 환율유형
            gfnma_setComSelect(['gvwList'], jsonExchangeType, 'L_COM034', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            // 거래유형
            gfnma_setComSelect(['gvwDetail'], jsonTxnGroupCode, 'L_FIM071', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            // 은행코드
            gfnma_setComSelect(['gvwDetail'], jsonBankCode, 'L_BANK_CODE', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'BANK_CD', 'BANK_NM', 'Y', ''),
            // 거래처
            gfnma_setComSelect(['gvwDetail'], jsonPayerId, 'L_COMP_ID', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'CNPT_CD', 'CNPT_NM', 'Y', ''),
            // 전표유형
            gfnma_setComSelect(['gvwDetail', 'gvwAccount'], jsonDocType, 'L_FIM051', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            // 전표상태
            ...
            // 상태코드
            gfnma_setComSelect(['gvwDetail'], jsonStatusCode, 'L_FIM074', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            // LINE
...
/*        SBGridProperties.total = {
    ...
    const fn_findBankCsCode = function() {
        ...
        compopup1({
            ...
            ,itemSelectEvent		: function (data){
                SBUxMethod.set('SRCH_BANK_CS_NAME', data.CNPT_NM);
                SBUxMethod.set('SRCH_BANK_CS_CODE', data.CNPT_CD);
            },
        });
    }
    ...
    const fn_findAccountNo = function() {
        ...
        compopup1({
            ...
            ,itemSelectEvent		: function (data){
                SBUxMethod.set('SRCH_ACCOUNT_NO', data.ACTNO);
                SBUxMethod.set('SRCH_DEPOSIT_CODE', data.DPMNY_CD);
            },
        });
    }
    ...
    const fn_onload = async function () {
        ...
        gfnma_multiSelectSet('#SRCH_TXN_TYPE', 'SBSD_CD', 'CD_NM', "1");
                ...
                if(strWorkType == "Q") {
                    ...
                    data.cv_1.forEach((item, index) => {
                        const msg = {
                            ...
                            OUT_DEPOSIT_SEQ: item.TKMNY_DPMNY_SEQ,
                            ...
                            WITHHOLD_BRANCH_NAME: item.WTHD_BRNCH_NM,
                            WITHHOLD_BIZ_REGNO: item.WTHD_BRNCH_BRNO,
                        }
