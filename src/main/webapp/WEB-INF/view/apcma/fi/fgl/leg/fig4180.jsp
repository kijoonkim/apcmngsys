...
<script type="text/javascript">
    ...
    function fn_createFig4180QGrid() {
        ...
        SBGridProperties.columns = [
            ...
            {caption: ["사업자번호"], 				ref: 'BIZ_REGNO', 				type:'output',		width:'120px',  	style:'text-align:left'},
            
            {caption: ["전기(월)이월"],    			ref: 'BEGIN_AMT_F', 			type:'output',  	width:'150px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            {caption: ["증가금액"], 	   			ref: 'IN_AMT_F', 				type:'output',  	width:'150px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            {caption: ["감소금액"],		   			ref: 'OUT_AMT_F', 				type:'output',  	width:'150px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            {caption: ["잔액"], 		   			ref: 'BALANCE_AMT_F', 			type:'output',  	width:'150px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            ...
            {caption: ["전기(월)이월(통화)"],		ref: 'BEGIN_AMT_O', 			type:'output',  	width:'150px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            {caption: ["증가금액(통화)"],  			ref: 'IN_AMT_O', 				type:'output',  	width:'150px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            {caption: ["감소금액(통화)"],	 		ref: 'OUT_AMT_O', 				type:'output',  	width:'150px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            {caption: ["잔액(통화)"], 	   			ref: 'BALANCE_AMT_O', 			type:'output',  	width:'150px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
        ];
    ...
    function fn_createFig4180Q2Grid() {
        ...
        SBGridProperties.total 				= {
                ...
                columns		: {
                    standard : [0],
                    sum : [12,13,14,15,16,23,24,25,26,27]
                },
                grandtotalrow : {
                    titlecol 		: 11,
                    titlevalue		: '합계',
        ...
        SBGridProperties.columns = [
            ...
            {caption: ["순금액(전표)"],				ref: 'FUNCTIONAL_AMT', 			type:'output',  	width:'150px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            {caption: ["잔액(전표)"], 	   			ref: 'FUNCTIONAL_BALANCE_AMT', 	type:'output',  	width:'150px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            {caption: ["잔액(전표2)"],	   			ref: 'FUNCTIONAL_BALANCE_AMT2',	type:'output',  	width:'150px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            ...
            {caption: ["순금액(통화)"],  			ref: 'ORIGINAL_AMT', 			type:'output',  	width:'150px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            {caption: ["잔액(통화)"],	 			ref: 'ORIGINAL_BALANCE_AMT', 	type:'output',  	width:'150px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            {caption: ["잔액(통화2)"], 	   			ref: 'ORIGINAL_BALANCE_AMT2', 	type:'output',  	width:'150px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
        ];
  			...
  			if (_.isEqual("S", data.resultStatus)) {
  	        	...
  	        	data.cv_1.forEach((item, index) => {
  					const msg = {
						...
						BALANCE_AMT_F				: gfnma_nvl2(item.BALANCE_AMT_F),			
						BALANCE_AMT_O				: gfnma_nvl2(item.BALANCE_AMT_O),			
						BEGIN_AMT_F					: gfnma_nvl2(item.BEGIN_AMT_F),			
						BEGIN_AMT_O					: gfnma_nvl2(item.BEGIN_AMT_O),			
						
						BIZ_REGNO					: (item.BIZ_REGNO == '--' ) ? '' : gfnma_nvl2(item.BIZ_REGNO),			
						...
						IN_AMT_F					: gfnma_nvl2(item.IN_AMT_F),
						IN_AMT_O					: gfnma_nvl2(item.IN_AMT_O),
						OUT_AMT_F					: gfnma_nvl2(item.OUT_AMT_F),
						OUT_AMT_O					: gfnma_nvl2(item.OUT_AMT_O),
						PERIOD_CODE					: gfnma_nvl2(item.PERIOD_CODE),
  					}
  			...
  			if (_.isEqual("S", data.resultStatus)) {
  	        	...
  	        	data.cv_1.forEach((item, index) => {
  					const msg = {
						...
						BALANCE_SIDE				: gfnma_nvl2(item.BALANCE_SIDE),		
						BANK_ACCOUNT_SEQ			: gfnma_nvl2(item.BANK_ACCOUNT_SEQ),		
						BATCH_NO					: gfnma_nvl2(item.BATCH_NO),		
						...
						FUNCTIONAL_BALANCE_AMT		: gfnma_nvl2(item.FUNCTIONAL_BALANCE_AMT),		
						FUNCTIONAL_BALANCE_AMT2		: gfnma_nvl2(item.FUNCTIONAL_BALANCE_AMT2),		
						FUNCTIONAL_CR_AMT			: gfnma_nvl2(item.FUNCTIONAL_CR_AMT),		
						FUNCTIONAL_DR_AMT			: gfnma_nvl2(item.FUNCTIONAL_DR_AMT),		
						
						HOLD_DATE					: gfnma_date5(gfnma_nvl2(item.HOLD_DATE)),
						...
						ORIGINAL_BALANCE_AMT		: gfnma_nvl2(item.ORIGINAL_BALANCE_AMT),		
						ORIGINAL_BALANCE_AMT2		: gfnma_nvl2(item.ORIGINAL_BALANCE_AMT2),		
						...
						RELEASE_DATE				: gfnma_date5(gfnma_nvl2(item.RELEASE_DATE)),
						...
						WRITE_DEPT_NAME				: gfnma_nvl2(item.WRITE_DEPT_NAME),		
