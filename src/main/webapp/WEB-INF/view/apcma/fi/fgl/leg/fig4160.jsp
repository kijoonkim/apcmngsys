    ...
    <section>
        <div class="box box-solid" style="border-radius:0px">
            <div class="box-header" style="display:flex; justify-content: flex-start;">
                ...
                <div style="margin-left: auto;">
           			<sbux-checkbox 
           				...
           				uitype="normal" 
           				text="3개월이상 집계" 
           				style="padding-right:10px !important;font-size:12px"
           				true-value="Y" 
           				false-value="N" >
           			</sbux-checkbox>
            ...
            <div class="box-body">
	                ...
	                <table id="srchArea1" class="table table-bordered tbl_fixed table-search-ma">
	                    ...
	                    <tbody>
	                    	...
	                    	<tr>
	                            ...
	                            <th scope="row" class="th_bg_search">소속사업장</th>
	                    	...
	                    	<tr>
	                            ...
	                            <th scope="row" class="th_bg_search">합계표시여부</th>
	                            <td colspan="3" class="td_input" >
	                       			<sbux-checkbox 
	                       				id="SCH_SUM_YN" 
	                       				uitype="normal" 
	                            ...
	                            <td colspan="9" class="td_input" >
	                            	<div style="display:flex;float:left;vertical-align:middle;width:100%">
										...
										<sbux-button
	   									...
	   									<font style="width:5px"></font>
	   									<sbux-input style="width:100px"  placeholder="계정과목명" id="SCH_ACCOUNT_NAME_FR" uitype="text" class="form-control input-sm"></sbux-input>
	   									<font style="width:5px"></font>
					                    <font>~</font>
	   									<font style="width:5px"></font>
										...
										<sbux-button
	   									...
	   									<font style="width:5px"></font>
	   									<sbux-input style="width:100px" placeholder="계정과목명" id="SCH_ACCOUNT_NAME_TO" uitype="text" class="form-control input-sm"></sbux-input>
	   									<font style="width:5px"></font>
                ...
                <div>
                    <div id="SB_AREA_GRDTOP" style="height:500px; width:100%;">
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
	...
	const fn_initSBSelect = async function() {
		let rst = await Promise.all([
            ...
            // 전표상태
            gfnma_setComSelect(['SCH_DOC_STATUS'], 			jsonDocStatus, 		'L_FIG002', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            // 특수관계자유형
            ...
            // 특수관계자여부
            gfnma_setComSelect(['SCH_YES_NO'], 				jsonYesNo, 			'L_COM036', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
		]);
	}	
  			...
  			if (_.isEqual("S", data.resultStatus)) {
  	        	...
  	        	data.cv_1.forEach((item, index) => {
  					const msg = {
						...
						SOURCE_DOC_ID				: gfnma_nvl2(item.SRC_DOC_ID),
						SOURCE_DOC_NAME				: gfnma_nvl2(item.SRC_SLIP_NM),
