...
<script type="text/javascript">
    ...
    function fn_createFig2410Grid() {
        ...
        SBGridProperties.columns = [
            ...
            {caption: ["전체외화금액"], 	 		ref: 'ORIGINAL_AMOUNT', 		type:'output',  	width:'120px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            {caption: ["전체원화금액"], 	 		ref: 'FUNCTIONAL_AMOUNT', 		type:'output',  	width:'120px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            {caption: ["차/대"],					ref: 'DEBIT_CREDIT', 			type:'output', 		width:'80px', 		style:'text-align:left'},
            
            {caption: ["차변(원래)"], 	 			ref: 'ORIGINAL_DR_AMT', 		type:'output',  	width:'120px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            {caption: ["대변(원래)"], 				ref: 'ORIGINAL_CR_AMT', 		type:'output',  	width:'120px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            {caption: ["차변금액"],	 	  			ref: 'FUNCTIONAL_DR_AMT',		type:'output',  	width:'120px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            {caption: ["대변금액"], 	   			ref: 'FUNCTIONAL_CR_AMT', 		type:'output',  	width:'120px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
            ...
            {caption: ["잔액"], 		   			ref: 'NET_AMOUNT', 				type:'output',  	width:'120px',  	style:'text-align:right', format : {type:'number', rule:'#,##0'}},
