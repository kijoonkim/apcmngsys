...
//         			}
            ...
            // 전표구분
            gfnma_setComSelect2(['DOC_TYPE'], jsonDocType, jsonBizCompData, 'L_FIM051', '' + (strsourceType == "AP" ? "AND APS_SLIP_WRT_YN = 'Y'" : (strsourceType == "BAD" ? "AND SLIP_TYPE like '91%'" : "AND AR_SLIP_WRT_YN = 'Y'")), gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            // 전표상태
            gfnma_multiSelectInit2({
                target: ['#DOC_STATUS']
                , compCode: gv_ma_selectedCorpCd
            ...
            gfnma_multiSelectInit2({
                ...
                , columns: [
                    ...
                    {caption: "사용자명", ref: 'USER_NM', width: '150px', style: 'text-align:left'}
                ]
            }, jsonBizCompData),
            // 증빙유형
            gfnma_setComSelect2(['VOUCHER_TYPE'], jsonVoucherType, jsonBizCompData, 'L_FIG005', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            // 지급방법
            gfnma_multiSelectInit2({
                target: ['#PAY_METHOD']
                , compCode: gv_ma_selectedCorpCd
                ...
                , columns: [
                    ...
                    {caption: "코드명", ref: 'CD_NM', width: '140px', style: 'text-align:left'},
...
//                     ,{caption: "비고", ref: 'DESCIPTION', width: '150px', style: 'text-align:left'}
            ...
            // 세금코드
            gfnma_setComSelect2([''], jsonVatCode, jsonBizCompData, 'L_VAT_INFO', "AND A.USE_YN = 'Y' AND B.AR_AP_TYPE = '" + strsourceType + "'", gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'VAT_CD', 'VAT_NM', 'Y', ''),
            gfnma_multiSelectInit2({
                target: ['#VAT_CODE']
                , compCode: gv_ma_selectedCorpCd
                , clientCode: gv_ma_selectedClntCd
            ...
            // 은행코드
            gfnma_setComSelect2(['BANK_CODE'], jsonBankCode, jsonBizCompData, 'L_BANK_CODE', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'BANK_CD', 'BANK_NM', 'Y', ''),
            // 전자발행
            gfnma_multiSelectInit2({
                target: ['#ETAX_TYPE']
                , compCode: gv_ma_selectedCorpCd
                ...
                , columns: [
                    {caption: "코드", ref: 'SBSD_CD', width: '50px', style: 'text-align:left'},
                    {caption: "발행구분", ref: 'CD_NM', width: '150px', style: 'text-align:left'}
                ]
                , callback : function(value) {
            ...
            gfnma_multiSelectInit2({
                ...
                , columns: [
                    {caption: "코드", ref: 'SBSD_CD', width: '50px', style: 'text-align:left'},
                    {caption: "카드구분", ref: 'CD_NM', width: '150px', style: 'text-align:left'}
                ]
                , callback : function(value) {
                    var nRow = gvwWFItem.getRow();
                    if(nRow < 0) return;
            ...
            gfnma_multiSelectInit2({
                ...
                , columns: [
                    {caption: "코드", ref: 'SBSD_CD', width: '50px', style: 'text-align:left'},
                    {caption: "구분", ref: 'CD_NM', width: '150px', style: 'text-align:left'}
                ]
                , callback : function(value) {
                    var nRow = gvwWFItem.getRow();
                    if(nRow < 0) return;
            ...
            gfnma_multiSelectInit2({
                ...
                , columns: [
                    {caption: "코드", ref: 'SBSD_CD', width: '50px', style: 'text-align:left'},
                    {caption: "불공제 사유 유형", ref: 'CD_NM', width: '230px', style: 'text-align:left'}
                ]
                , callback : function(value) {
                    var nRow = gvwWFItem.getRow();
                    if(nRow < 0) return;
            ...
            gfnma_multiSelectInit2({
                ...
                , columns: [
                    {caption: "코드", ref: 'SBSD_CD', width: '50px', style: 'text-align:left'},
                    {caption: "해당여부", ref: 'CD_NM', width: '80px', style: 'text-align:left'}
                ]
                , callback : function(value) {
                    var nRow = gvwWFItem.getRow();
                    if(nRow < 0) return;
            ...
            gfnma_multiSelectInit2({
                ...
                , columns: [
                    {caption: "코드", ref: 'SBSD_CD', width: '50px', style: 'text-align:left'},
                    {caption: "구분", ref: 'CD_NM', width: '50px', style: 'text-align:left'}
                ]
                , callback : function(value) {
                    var nRow = gvwWFItem.getRow();
                    if(nRow < 0) return;
            ...
            gfnma_multiSelectInit2({
                ...
                , columns: [
                    {caption: "코드", ref: 'SBSD_CD', width: '50px', style: 'text-align:left'},
                    {caption: "자산구분", ref: 'CD_NM', width: '100px', style: 'text-align:left'}
                ]
                , callback : function(value) {
                    var nRow = gvwWFItem.getRow();
                    if(nRow < 0) return;
            ...
            gfnma_multiSelectInit2({
                ...
                , columns: [
                    {caption: "코드", ref: 'SBSD_CD', width: '50px', style: 'text-align:left'},
                    {caption: "해당여부", ref: 'CD_NM', width: '100px', style: 'text-align:left'}
                ]
                , callback : function(value) {
                    var nRow = gvwWFItem.getRow();
                    if(nRow < 0) return;
            ...
            // 수입금액제외
            gfnma_setComSelect2(['gvwWFItem'], jsonZeroType, jsonBizCompData, 'L_FIT010', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            gfnma_multiSelectInit2({
                target: ['#ZERO_TYPE']
                , compCode: gv_ma_selectedCorpCd
                , clientCode: gv_ma_selectedClntCd
            ...
            // 계좌정보
            gfnma_setComSelect2([''], jsonBankAccountSeq, jsonBizCompData, 'L_CS_ACCOUNT', "AND A.CNPT_CD = '" + gfn_nvl(SBUxMethod.get("CS_CODE")) + "' AND '" + gfn_nvl(SBUxMethod.get("DOC_DATE")) + "' BETWEEN A.EFCT_BGNG_YMD AND A.EFCT_END_YMD", gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'BACNT_SEQ', 'SEQ_NAME', 'Y', ''),
            gfnma_multiSelectInit2({
            ...
            // 유형
            gfnma_setComSelect2(['gvwWFItem'], jsonLineType, jsonBizCompData, 'L_FIM052', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            // 차/대
            gfnma_setComSelect2(['gvwWFItem'], jsonDebitCredit, jsonBizCompData, 'L_FIG003', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            // 관리항목코드
            gfnma_setComSelect2(['gvwWFItem'], jsonAccItemCode, jsonBizCompData, 'P_FIM041', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'ACC_ITEM_VALUE', 'ACC_VALUE_NAME', 'Y', ''),
            // 통화코드
            gfnma_setComSelect2(['gvwWFItem'], jsonCurrencyCode, jsonBizCompData, 'L_COM001', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'CRN_CD', 'CRN_NM', 'Y', ''),
            // 여신영역
            gfnma_setComSelect2(['gvwWFItem'], jsonCreditArea, jsonBizCompData, 'L_ORG020', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', ''),
            // 사업장
            gfnma_setComSelect2(['gvwWFItem'], jsonSiteCode, jsonBizCompData, 'L_ORG001', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SITE_CD', 'SITE_NM', 'Y', ''),
            //필요없는 체크박스 하이드
            SBUxMethod.hide('OPEN_TO_ALL_YN'),
        ]);
    }
...
//     }
    ...
    const fn_baseFocusedRowChanged = async function (nRow, nCol) {
        ...
        if (gvwWFItem.getCellData(nRow, gvwWFItem.getColRef("LINE_TYPE")) == "3") {
            ...
            gfnma_multiSelectSet('#ETAX_TYPE', 'SBSD_CD', 'CD_NM', rowData.ETAX_TYPE);
            gfnma_multiSelectSet('#CARD_USE_TYPE', 'SBSD_CD', 'CD_NM', rowData.CARD_USE_TYPE);
            gfnma_multiSelectSet('#LOCAL_CREDIT_TYPE', 'SBSD_CD', 'CD_NM', rowData.LOCAL_CREDIT_TYPE);
            gfnma_multiSelectSet('#VAT_NOT_DEDUCTION_TYPE', 'SBSD_CD', 'CD_NM', rowData.VAT_NOT_DEDUCTION_TYPE);
            gfnma_multiSelectSet('#REPORT_OMIT_YN', 'SBSD_CD', 'CD_NM', rowData.REPORT_OMIT_YN);
            gfnma_multiSelectSet('#DUP_ISSUE_BILL_TYPE', 'SBSD_CD', 'CD_NM', rowData.DUP_ISSUE_BILL_TYPE);
            gfnma_multiSelectSet('#VAT_ASSET_TYPE', 'SBSD_CD', 'CD_NM', rowData.VAT_ASSET_TYPE);
            gfnma_multiSelectSet('#AFTER_DUE_DATE_YN', 'SBSD_CD', 'CD_NM', rowData.AFTER_DUE_DATE_YN);
            gfnma_multiSelectSet('#ZERO_REPORT_YN', 'SBSD_CD', 'CD_NM', rowData.ZERO_REPORT_YN);
            gfnma_multiSelectSet('#EXCLUDE_REVENUE_AMT_YN', 'SBSD_CD', 'CD_NM', rowData.EXCLUDE_REVENUE_AMT_YN);
            gfnma_multiSelectSet('#ZERO_TYPE', 'SBSD_CD', 'CD_NM', rowData.ZERO_TYPE);
...
//                 gfnma_multiSelectSet('#SUB_TAX_SITE_CODE', 'TAX_SITE_CODE', 'TAX_SITE_NAME', "T02");
    ...
    const fn_create = async function () {
        ...
        gfnma_multiSelectSet('#DOC_STATUS', 'SBSD_CD', 'CD_NM', "1");
        ...
        gfnma_multiSelectSet('#PAYEE_CODE', 'USER_ID', 'USER_NM', p_userId);
        ...
        try {
            if (_.isEqual("S", listData.resultStatus)) {
                ...
                if(formData) {
                    ...
                    SBUxMethod.set('SRCH_DOC_H_FI_ORG_CODE', formData.ACNTG_OGNZ_CD);
                    SBUxMethod.set('SRCH_SITE_CODE', formData.SITE_CD);
                    SBUxMethod.set('DEPT_CODE', formData.DEPT_CD);
                    SBUxMethod.set('DEPT_NAME', formData.DEPT_NM);
                    SBUxMethod.set('DOC_ID', formData.SLIP_ID);
                    SBUxMethod.set('DOC_TYPE', formData.SLIP_TYPE);
                    SBUxMethod.set('DOC_DATE', formData.SLIP_YMD);
                    SBUxMethod.set('CS_CODE', formData.CNPT_CD);
                    SBUxMethod.set('CS_NAME', formData.CNPT_NM);
                    ...
                    SBUxMethod.set('PAY_TERM_NAME', formData.PAY_TERM_NM);
                    SBUxMethod.set('VAT_AMOUNT', formData.VAT_AMT);
                    SBUxMethod.set('STANDARD_DATE', formData.DCLR_YMD);
                    SBUxMethod.set('SUPPLY_AMT', formData.SPLY_AMT);
                    SBUxMethod.set('DESCRIPTION', formData.DSCTN);
                    SBUxMethod.set('PAY_BASE_DATE', formData.PAY_RCK_YMD);
                    SBUxMethod.set('EXPECTED_PAY_DATE', formData.PAY_PRNMNT_YMD);
                    SBUxMethod.set('BASIS_TYPE', formData.BASE_CRN_CD);
                    fn_changeBasisType();
                    SBUxMethod.set('DIFF_DAY', formData.DIFF_DAY);
                    SBUxMethod.set('BILL_DUE_DATE', formData.PRMNT_MTRY_YMD);
                    SBUxMethod.set('BILL_DUE_DAY', formData.PRMNT_DCNT);
                    SBUxMethod.set('BILL_DUE_PAY_DATE', formData.PRMNT_MTRY_PAY_YMD);
                    SBUxMethod.set('VOUCHER_RECEIPT_DATE', formData.EVDNC_RCPT_YMD);
                    SBUxMethod.set('VOUCHER_TYPE', formData.EVDNC_TYPE);
                    SBUxMethod.set('VOUCHER_NO', formData.EVDNC_NO);
                    gfnma_multiSelectSet('#PAYEE_CODE', 'USER_ID', 'USER_NM', gfn_nvl(formData.RCPNT_CD));
                    SBUxMethod.set('PAYEE_NAME', formData.PAYEE_NAME);
                    SBUxMethod.set('APPROVE_DATE', formData.APRV_YMD);
                    SBUxMethod.set('FINAL_APPROVER', formData.FINAL_APPROVER);
                    gfnma_multiSelectSet('#DOC_STATUS', 'SBSD_CD', 'CD_NM', gfn_nvl(formData.SLIP_STTS));
                    SBUxMethod.set('ACCT_OPINION', formData.ACNTG_OPN);
                    SBUxMethod.set('TR_OPINION', formData.FUND_OPNN);
                    SBUxMethod.set('POSTING_DATE', formData.PSTG_YMD);
                    SBUxMethod.set('POSTING_USER', formData.PSTG_PIC);
                    SBUxMethod.set('UNPOSTING_DATE', formData.PSTG_CNCL_YMD);
                    SBUxMethod.set('UNPOSTING_USER', formData.PSTG_CNCL_USER);
                    ...
                    SBUxMethod.set('REVERSE_DOC_ID', formData.REVE_SLIP_ID);
                    SBUxMethod.set('ORIG_DOC_ID', formData.ORGNL_SLIP_ID);
                    ...
                    SBUxMethod.set('BILL_NO', formData.PRMNT_NO);
                    await gfnma_multiSelectSet('#BANK_ACCOUNT_SEQ', 'BANK_ACCOUNT_SEQ', 'SEQ_NAME', gfn_nvl(formData.BACNT_SEQ));
                }
                ...
                listData.cv_2.forEach((item, index) => {
                    var msg = {
                        ...
                        ITEM_SOURCE_TYPE: item.ITEM_SRC_TYPE,
                        ITEM_DOC_NAME: item.ITEM_SLIP_NO,
                        SOURCE_RECORD_COUNT: item.SRC_RCRD_CNT,
                        PROJECT_YN: item.PJT_YN,
                        CS_CODE: item.CNPT_CD,
                        PO_LINE_NO: item.PORDR_LINE_NO,
                        CREDIT_AREA: item.CRDT_SECT,
                        SALES_PERSON: item.SALS_EMP,
                        CURRENCY_CODE: item.CRN_CD,
                        EXCHANGE_TYPE: item.EXCHRT_TYPE,
                        EXCHANGE_RATE: item.EXCHRT,
                        BASE_SCALE: item.BASE_SCALE,
                        WITHHOLD_FLAG: item.WTHD_FLAG,
                        WITHHOLD_TAX_TYPE: item.WTHD_TX_TYPE,
                        WITHHOLD_CS_CODE: item.WTHD_CNPT_CD,
                        WITHHOLD_TAX_TYPE2: item.WTHD_TX_TYPE2,
                        WITHHOLD_CS_CODE2: item.WTHD_CNPT_CD2,
                        ...
                        VOUCHER_NO1: item.EVDNC_NO1,
                        VOUCHER_RECEIPT_DATE: item.EVDNC_RCPT_YMD,
                        FI_ORG_CODE: item.ACNTG_OGNZ_CD,
                        SITE_CODE: item.SITE_CD,
                        APPLY_COMPLETE_DATE: item.REVE_CMPTN_YMD,
                        APPLY_COMPLETE_FLAG: item.REVE_CMPTN_FLAG,
                        SALES_CS_CODE: item.SLL_CNPT_CD,
                        ETAX_TYPE: item.ELDOC_TYPE,
                        AFTER_DUE_DATE_YN: item.AFTR_DUDT_SEND_YN,
                        DUP_ISSUE_BILL_TYPE: item.DPCN_ISSU_BILL_TYPE,
                        EXCLUDE_REVENUE_AMT_YN: item.EXCLUDE_REVENUE_AMT_YN,
                        CARD_USE_TYPE: item.CARD_USG_TYPE,
                        CARD_NUM: item.CARD_NO,
                        VAT_NOT_DEDUCTION_TYPE: item.VAT_NOT_DEDUCTION_TYPE,
                        REPORT_OMIT_YN: item.RPT_PRNMNT_YN,
                        STANDARD_DATE: item.DCLR_YMD,
                        VAT_ASSET_TYPE: item.VAT_AST_TYPE,
                        ...
                        EXPORT_AMT_KRW: item.EXPRT_AMT_KRW,
                        VAT_EXPORT_AMT: item.VAT_THTM_EXPRT_AMT,
                        ...
                        RELEASE_USER: item.RMV_USER,
                        HOLD_DATE: item.HLDOF_YMD,
                        HOLD_USER: item.HLDOF_USER,
                        HOLD_REASON: item.HLDOF_RSN,
                        ...
                        PAY_TERM_ORIG: item.PAY_TERM_FRST,
                        PROD_GROUP: item.PRDCT_GRP,
                        BANK_ACCOUNT_SEQ: item.BACNT_SEQ,
                        MATL_NO: item.INDIV_NO,
                        PROD_ORDER_NO: item.PRDCTN_ORDR_NO,
                        SALES_NO: item.SLS_NO,
                        ORDER_NO: item.ORDR_NO,
