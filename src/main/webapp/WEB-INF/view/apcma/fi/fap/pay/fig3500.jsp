<%
    /**
     * @Class Name 		: fig3500.jsp
     * @Description 	: 송장등록및조회(매입) 화면
     * @author 			: 인텔릭아이앤에스
     * @since 			: 2024.08.07
     * @version 		: 1.0
                ...
                <table id="dataArea1" class="table table-bordered tbl_fixed table-search-ma">
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="td_input" style="border-right:hidden;">
                            <div class="dropdown">
                                <button style="width:100%;text-align:left" class="btn btn-sm btn-light dropdown-toggle"
                                        type="button" id="SRCH_FI_ORG_CODE" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                    <font>선택</font>
                        ...
                        <td colspan="3" class="td_input" style="border-right:hidden;">
                            <div class="dropdown">
                                <button style="width:100%;text-align:left" class="btn btn-sm btn-light dropdown-toggle"
                                        type="button" id="SRCH_DOC_STATUS" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                    <font>선택</font>
                                    <i style="padding-left:10px" class="sbux-sidemeu-ico fas fa-angle-down"></i>
                                </button>
                                <div class="dropdown-menu" aria-labelledby="SRCH_DOC_STATUS"
                                     style="width:300px;height:150px;padding-top:0px;overflow:auto">
                                </div>
                            </div>
                        </td>
                        ...
                        <td colspan="3" class="td_input" style="border-right:hidden;">
                            <div class="dropdown">
                                <button style="width:100%;text-align:left" class="btn btn-sm btn-light dropdown-toggle"
                                        type="button" id="SRCH_HOLD_FLAG" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                    <font>선택</font>
                                    <i style="padding-left:10px" class="sbux-sidemeu-ico fas fa-angle-down"></i>
                                </button>
                                <div class="dropdown-menu" aria-labelledby="SRCH_HOLD_FLAG"
                                     style="width:300px;height:150px;padding-top:0px;overflow:auto">
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="td_input">
                            <sbux-input id="SRCH_CREATED_DEPT_CODE"
                                        name="SRCH_CREATED_DEPT_CODE"
                                        class="form-control input-sm"
                                        uitype="text"
                                        style="width:100%"
                            ></sbux-input>
                        ...
                        <td colspan="2" class="td_input">
                            <sbux-input id="SRCH_CREATED_DEPT_NAME"
                                        name="SRCH_CREATED_DEPT_NAME"
                                        class="form-control input-sm"
                                        uitype="text"
                                        style="width:100%"
                            ></sbux-input>
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="td_input" style="border-right:hidden;">
                            <div class="dropdown">
                                <button style="width:100%;text-align:left" class="btn btn-sm btn-light dropdown-toggle"
                                        type="button" id="SRCH_DOC_TYPE" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                    <font>선택</font>
                                    <i style="padding-left:10px" class="sbux-sidemeu-ico fas fa-angle-down"></i>
                                </button>
                                <div class="dropdown-menu" aria-labelledby="SRCH_DOC_TYPE"
                                     style="width:300px;height:150px;padding-top:0px;overflow:auto">
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="td_input">
                            <sbux-input id="SRCH_CREATED_BY_CODE"
                                        name="SRCH_CREATED_BY_CODE"
                                        class="form-control input-sm"
                                        uitype="text"
                                        style="width:100%"
                            ></sbux-input>
                        ...
                        <td colspan="2" class="td_input">
                            <sbux-input id="SRCH_CREATED_BY_NAME"
                                        name="SRCH_CREATED_BY_NAME"
                                        class="form-control input-sm"
                                        uitype="text"
                                        style="width:100%"
                            ></sbux-input>
                        ...
                        <td colspan="5" class="td_input" style="border-right:hidden;">
                            <sbux-checkbox
                                    uitype="normal"
                                    id="SRCH_CARD_EXCEPT_FLAG"
                                    name="SRCH_CARD_EXCEPT_FLAG"
                                    uitype="normal"
                                    class="form-control input-sm check"
                                    text="ESS제외여부"
                                    true-value="Y" false-value="N"
                    ...
                    <tr>
                        ...
                        <td class="td_input">
                            <sbux-input id="SRCH_PAYEE_DEPT_CODE"
                                        name="SRCH_PAYEE_DEPT_CODE"
                                        class="form-control input-sm"
                                        uitype="text"
                                        style="width:100%"
                            ></sbux-input>
                        ...
                        <td colspan="2" class="td_input">
                            <sbux-input id="SRCH_PAYEE_DEPT_NAME"
                                        name="SRCH_PAYEE_DEPT_NAME"
                                        class="form-control input-sm"
                                        uitype="text"
                                        style="width:100%"
                            ></sbux-input>
                        ...
                        <td class="td_input">
                            <sbux-input id="SRCH_PAYEE_CODE"
                                        name="SRCH_PAYEE_CODE"
                                        class="form-control input-sm"
                                        uitype="text"
                                        style="width:100%"
                            ></sbux-input>
                        ...
                        <td colspan="2" class="td_input">
                            <sbux-input id="SRCH_PAYEE_NAME"
                                        name="SRCH_PAYEE_NAME"
                                        class="form-control input-sm"
                                        uitype="text"
                                        style="width:100%"
                            ></sbux-input>
                    ...
                    <tr>
                        ...
                        <td colspan="4" class="td_input" style="border-right:hidden;">
                            <sbux-input id="SRCH_DOC_NAME" uitype="text" placeholder=""
                        ...
                        <td colspan="8" class="td_input" style="border-right:hidden;">
                            <sbux-input id="SRCH_DESC" uitype="text" placeholder=""
                                        class="form-control input-sm"></sbux-input>
                        </td>
                        <td <%--colspan="2" --%>style="border-right: hidden;"></td>
                    </tr>
                    <tr style="display: none"><%--/***********숨겨져 있는 컬럼***********/--%>
                        <td class="td_input" style="border-right:hidden;">
                            <sbux-input id="TXTPAYEE_DEPT" uitype="text" placeholder=""
                                        class="form-control input-sm"></sbux-input>
                        </td>
                        <td class="td_input" style="border-right:hidden;">
                            <sbux-input id="TXTCREATED_DEPT" uitype="text" placeholder=""
                                        class="form-control input-sm"></sbux-input>
                        </td>
                        <td class="td_input" style="border-right:hidden;">
                            <sbux-input id="TXTSOURCE_TYPE" uitype="text" placeholder=""
                                        class="form-control input-sm"></sbux-input>
                        </td>
                        <td class="td_input" style="border-right:hidden;">
                            <sbux-input id="SRCH_PAYER_ID" uitype="text" placeholder=""
                                        class="form-control input-sm"></sbux-input>
                        </td>
                        <td class="td_input" style="border-right:hidden;">
                            <sbux-input id="TXTCREATED_BY" uitype="text" placeholder=""
                                        class="form-control input-sm"></sbux-input>
                        </td>
                        <td class="td_input" style="border-right:hidden;">
                            <sbux-input id="TXTPAYEE_CODE" uitype="text" placeholder=""
                                        class="form-control input-sm"></sbux-input>
                        </td>
                        <td class="td_input" style="border-right:hidden;">
                            <sbux-input id="BTNDOC_BATCH_NO" uitype="text" placeholder=""
                                        class="form-control input-sm"></sbux-input>
                        </td>
                    </tr>
                    </tbody>
...
<script type="text/javascript">
    ...
    var jsonMasterTabData = [
        { "id" : "0", "pid" : "-1", "order" : "1", "text" : "매입송장", "targetid" : "tabPageEx1", "targetvalue" : "매입송장" },
    ...
    const fn_initSBSelect = async function() {
        ...
        let rst = await Promise.all([
            ...
            //전자구매전표
            gfnma_setComSelect(['gvwMaster'], jsonSignYn, 'L_FIG041', '', gv_ma_selectedApcCd, gv_ma_selectedClntCd, 'SUB_CODE', 'CODE_NAME', 'Y', ''),
    ...
    function fn_createGvwMasterGrid() {
       ...
       /* SBGridProperties.frozencols = 10;*/
        ...
        SBGridProperties.columns = [
            ...
            {caption: ["수취일"],       ref: 'VOUCHER_RECEIPT_DATE', 		type: 'inputdate',  	width:'97px',  	style:'text-align:left',
            ...
            {caption: ["공급가액"],         ref: 'SUPPLY_AMT',    type:'output',  	width:'120px',  style:'text-align:right',
                typeinfo : {mask : {alias : 'numeric'}, maxlength : 24}
                , format : {type:'number', rule:'#,###', emptyvalue:'0'}
            },
            {caption: ["부가세(￦)"],         ref: 'VAT_AMT',    type:'output',  	width:'120px',  style:'text-align:right',
                typeinfo : {mask : {alias : 'numeric'}, maxlength : 24}
                , format : {type:'number', rule:'#,###', emptyvalue:'0'}
            },
            ...
            {caption: ["전표유형"], 		ref: 'DOC_TYPE',   	    type:'combo', style:'text-align:left' ,width: '56px',
                typeinfo: {
                    ref			: 'jsonDocType',
                    label		: 'label',
                    value		: 'value',
            ...
            {caption: ["상신일자"],       ref: 'INSERT_DATE', 		type: 'inputdate',  	width:'97px',  	style:'text-align:left',
                typeinfo: {dateformat: 'yyyy-mm-dd'},
                format : {type:'date', rule:'yyyy-mm-dd', origin:'YYYYMMDD'}
                , disabled: true, hidden: true
            },
            {caption: ["청구자"],     ref: 'REQUEST_EMP',    type:'output',  	width:'182px',  style:'text-align:left'},
            {caption: ["직전결재자"], ref: 'BEFORE_APPR_EMP',    type:'output',  	width:'182px',  style:'text-align:left'},
            {caption: ["직전대행자"], ref: 'BEFORE_PROXY_EMP',    type:'output',  	width:'182px',  style:'text-align:left'},
            {caption: ["다음결재자"], ref: 'NEXT_APPR_EMP',    type:'output',  	width:'182px',  style:'text-align:left'},
            {caption: ["전표순번"],   ref: 'DOC_NUM', type: 'output', width: '140px', style: 'text-align:right'
            ...
            {caption: ["지급요청일자"],       ref: 'EXPECTED_PAY_DATE', 		type: 'inputdate',  	width:'97px',  	style:'text-align:left',
                typeinfo: {dateformat: 'yyyy-mm-dd'},
                format : {type:'date', rule:'yyyy-mm-dd', origin:'YYYYMMDD'}
                , disabled: true, hidden: true
            },
            {caption: ["지급예정일자"],       ref: 'TXN_EXP_PAY_DATE', 		type: 'inputdate',  	width:'97px',  	style:'text-align:left',
                typeinfo: {dateformat: 'yyyy-mm-dd'},
                format : {type:'date', rule:'yyyy-mm-dd', origin:'YYYYMMDD'}
                , disabled: true, hidden: true
            },
            {caption: ["지급일자"],       ref: 'PAY_DATE', 		type: 'inputdate',  	width:'97px',  	style:'text-align:left',
                typeinfo: {dateformat: 'yyyy-mm-dd'},
                format : {type:'date', rule:'yyyy-mm-dd', origin:'YYYYMMDD'}
                , disabled: true, hidden: true
            },
            {caption: ["거래처"], ref: 'PAYER_NAME',    type:'output',  	width:'182px',  style:'text-align:left'},
            {caption: ["사업자번호"], ref: 'PAYER_BIZ_REGNO',    type:'output',  	width:'182px',  style:'text-align:left'},
            ...
            {caption: ["통화"], 		ref: 'CURRENCY_CODE',   	    type:'combo', style:'text-align:left' ,width: '100px',
                typeinfo: {
            ...
            {caption: ["여신영억"], 		ref: 'CREDIT_AREA',   	    type:'combo', style:'text-align:left' ,width: '100px',
                typeinfo: {
                    ref			: 'jsonCreditArea',
                    label		: 'label',
                    value		: 'value',
            ...
            {caption: ["법인코드"],         ref: 'COMP_CODE',    type:'output',  	width:'133px',  style:'text-align:left'},
            ...
            {caption: ["반제일자"],       ref: 'APPLY_DOC_DATE', 		type: 'inputdate',  	width:'97px',  	style:'text-align:left',
                typeinfo: {dateformat: 'yyyy-mm-dd'},
                format : {type:'date', rule:'yyyy-mm-dd', origin:'YYYYMMDD'}
                , disabled: true, hidden: true
            },
            {caption: ["전자구매전표"], 		ref: 'SIGN_YN',   	    type:'combo', style:'text-align:left' ,width: '115px',
                typeinfo: {
                    ref			: 'jsonSignYn',
                    label		: 'label',
                    value		: 'value',
            ...
            {caption: ["결재유형"],         ref: 'APPR_SOURCE_TYPE',    type:'output',  	width:'75px',  style:'text-align:left', hidden: true},
    ...
    function fn_createGvwInfoGrid() {
        ...
        SBGridProperties.columns = [
            {caption: [""],			    ref: 'CHECK_YN', 			        type:'checkbox',  	width:'40px',  	style:'text-align:center', typeinfo : {fixedcellcheckbox : { usemode : true , rowindex : 0 , deletecaption : false }, checkedvalue: 'Y', uncheckedvalue: 'N'}},
            {caption: ["수취일"],       ref: 'VOUCHER_RECEIPT_DATE', 		type: 'inputdate',  	width:'100px',  	style:'text-align:left',
                typeinfo: {dateformat: 'yyyy-mm-dd'},
                format : {type:'date', rule:'yyyy-mm-dd', origin:'YYYYMMDD'}
                , disabled: true
            },
            ...
            {caption: ["공급가액"],         ref: 'SUPPLY_AMT',    type:'output',  	width:'130px',  style:'text-align:right',
                typeinfo : {mask : {alias : 'numeric'}, maxlength : 24}
                , format : {type:'number', rule:'#,###', emptyvalue:'0'}
            },
            {caption: ["부가세"],         ref: 'VAT_AMT',    type:'output',  	width:'100px',  style:'text-align:right',
                typeinfo : {mask : {alias : 'numeric'}, maxlength : 24}
                , format : {type:'number', rule:'#,###', emptyvalue:'0'}
            },
    ...
    function cfn_search() {
        ...
        fn_search(ACTIVE_MASTER_TAB == "tabPageEx1" ? "Q" : "Q2");
    }
    ...
    const fn_search = async function (ACTIVE_MASTER_TAB) {
        ...
        let PERIOD_YYYYMM = gfn_nvl(SBUxMethod.get("SRCH_PERIOD_YYYYMM")); //년월
        let PAYER_CODE = gfn_nvl(SBUxMethod.get("SRCH_PAYER_CODE")); //거래처
        let CREATED_DEPT_CODE = gfn_nvl(SBUxMethod.get("SRCH_CREATED_DEPT_CODE")); //작성부서
        let PAYEE_DEPT_CODE = gfn_nvl(SBUxMethod.get("SRCH_PAYEE_DEPT_CODE")); //청구부서
        let REVERSE_FLAG = gfn_nvl(SBUxMethod.get("SRCH_REVERSE_FLAG").SRCH_REVERSE_FLAG); //역분개제외여부
        let TXN_DATE_FROM = gfn_nvl(SBUxMethod.get("SRCH_TXN_DATE_FROM")); //거래일자
        let TXN_DATE_TO = gfn_nvl(SBUxMethod.get("SRCH_TXN_DATE_TO")); //거래일자
        let DOC_TYPE = gfn_nvl(gfnma_multiSelectGet("#SRCH_DOC_TYPE")); //전표구분
        let CREATED_BY_CODE = gfn_nvl(SBUxMethod.get("SRCH_CREATED_BY_CODE")); //작성자
        let PAYEE_CODE = gfn_nvl(SBUxMethod.get("SRCH_PAYEE_CODE")); //실사용자
        let CARD_EXCEPT_FLAG = gfn_nvl(SBUxMethod.get("SRCH_CARD_EXCEPT_FLAG").SRCH_CARD_EXCEPT_FLAG); //ESS제외여부
        let DOC_NAME = gfn_nvl(SBUxMethod.get("SRCH_DOC_NAME")); //전표번호
        let DOC_NAME_D = gfn_nvl(SBUxMethod.get("SRCH_MULTI_YN").SRCH_MULTI_YN) == "Y" ? strDocNameList : ""; //복수선택
        let DESC = gfn_nvl(SBUxMethod.get("SRCH_DESC")); //제목

        if (!TXN_DATE_FROM) {
            gfn_comAlert("W0002", "거래일자");
            return;
        }
        if (!TXN_DATE_TO) {
            gfn_comAlert("W0002", "거래일자");
        ...
        if (_.isEqual(ACTIVE_MASTER_TAB, 'Q2')){

            let nRow = gvwMaster.getRow();

            if (nRow != -1){

                let rowData = gvwMaster.getRowData(nRow);
        ...
        var paramObj = {
            ...
            ,V_P_CS_CODE          : PAYER_CODE
            ,V_P_PAYEE_DEPT       : PAYEE_DEPT_CODE
            ,V_P_PAYEE_CODE       : PAYEE_CODE
            ,V_P_DOC_STATUS       : DOC_STATUS
            ,V_P_CREATED_DEPT     : CREATED_DEPT_CODE
            ,V_P_CREATED_BY       : CREATED_BY_CODE
            ,V_P_REVERSE_FLAG 	  : REVERSE_FLAG
            ,V_P_HOLD_FLAG        : HOLD_FLAG
            ,V_P_CARD_EXCEPT_FLAG : CARD_EXCEPT_FLAG
        ...
        const postJsonPromiseForList = gfn_postJSON("/fi/fap/pay/selectFig3500List.do", {
            getType				: 'json',
            workType			: ACTIVE_MASTER_TAB,
            cv_count			: '4',
    ...
    const fn_save = async function () {
        ...
        if (gfn_comConfirm("Q0001", "수정 저장")) {
            ...
            if (listData.length > 0) {
                ...
                const postJsonPromise = gfn_postJSON("/fi/fap/pay/insertFig3500.do", {listData: listData});
    ...
    const getParamForm = async function (typeData) {
        ...
        let updateData = gvwInfo.getGridDataAll();
            ...
            updateData.forEach((item, index) => {
                ...
                if (_.isEqual(item.CHECK_YN, 'Y')) {
                    ...
                    const param = {
                        ...
                        cv_count: '0',
                        getType: 'json',
                        workType: 'U',/*item.status == 'i' ? 'N' : (item.status == 'u' ? 'U' : 'D'),*/
                        params: gfnma_objectToString({
                            ...
                            , V_P_DOC_ID: item.DOC_ID
                            , V_P_VOUCHER_RECEIPT_DATE: item.VOUCHER_RECEIPT_DATE
                            , V_P_VOUCHER_TYPE: item.VOUCHER_TYPE
                            , IV_P_VOUCHER_NO: item.VOUCHER_NO   //--승인번호(변경하고자 하는 번호)
    ...
    const fn_view = async function () {
        ...
        if(nCol == gvwMaster.getColRef("DOC_NAME")){
            ...
            let DOC_BATCH_NO = gfn_nvl(rowData.DOC_BATCH_NO);

            if (DOC_BATCH_NO != '') {
                var ht = {};
                ht["DOC_BATCH_NO"] = DOC_BATCH_NO;
                ht["SOURCE_TYPE"] = "AP";
                ht["DOC_NUM"] = gfn_nvl(rowData.DOC_NUM);
                ht["COMP_CODE"] = gv_ma_selectedApcCd;
                ht["FI_ORG_CODE"] = gfn_nvl(gfnma_multiSelectGet("#SRCH_FI_ORG_CODE"));
                ht["TXN_FROM_DATE"] = gfn_nvl(SBUxMethod.get("SRCH_TXN_DATE_FROM"));
                ht["TXN_TO_DATE"] = gfn_nvl(SBUxMethod.get("SRCH_TXN_DATE_TO"));
                ht["ASAVE"] = "Y";
                ht["APRINT"] = "Y";
                ht["VOUCHER_TYPE"] = gfn_nvl(rowData.VOUCHER_TYPE);
                ht["VOUCHER_NO"] = gfn_nvl(rowData.VOUCHER_NO);
    ...
    const fn_approve = async function () {
        ...
        gvwListCheckedList.forEach((item, index) => {
            ...
            // 체크가 되어있는 것 중에 전표상태가 승인중인 건 중에서
            if (_.isEqual(data.CHECK_YN, 'Y') && _.isEqual(data.DOC_STATUS, '3')) {
        ...
        if (intcount == 0) {
            ...
            const postJsonPromise = gfn_postJSON("/fi/fap/pay/insertFig3500S1.do", {
                getType				: 'json',
                workType			: 'APPROVE',
                cv_count			: '0',
                params				: gfnma_objectToString(paramObj)
