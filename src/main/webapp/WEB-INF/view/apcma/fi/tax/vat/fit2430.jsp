        ...
        <div class="box-body">
            ...
            <table id="srchTable" class="table table-bordered tbl_fixed">
                ...
                <tr>
                    ...
                    <th scope="row" class="th_bg">단위과세승인번호</th>
...
<script>
    ...
    const fn_createGrid = function(){
        ...
        SBGridProperties.columns = [
            {caption : ['사업장','종사업장번호'],ref : 'TAX_SITE_NAME',width : '100px', style : 'text-align:center', type : 'output'},
            {caption : ['사업장','신고사업장명'],ref : 'TAX_SITE_NAME',width : '100px', style : 'text-align:center', type : 'output'},
            {caption : ['사업장','사업장등록번호'],ref : 'TAX_SITE_NAME',width : '100px', style : 'text-align:center', type : 'output'},
            {caption : ['매출세액','구분'], ref : 'BIZ_REGNO', width : '100px',style : 'text-align:center', type : 'output'},
            {caption : ['매출세액','상세구분'], ref : 'BIZ_REGNO', width : '100px',style : 'text-align:center', type : 'output'},
            {caption : ['매출세액','과세표준'], ref : 'BIZ_REGNO', width : '100px',style : 'text-align:center', type : 'output'},
            ...
            {caption : ['매입세액','상세구분'], ref : 'BIZ_REGNO', width : '100px',style : 'text-align:center', type : 'output'},
            ...
            {caption : ['납부세액','납부세액'], ref : 'BIZ_REGNO', width : '100px',style : 'text-align:center', type : 'output'},
            {caption : ['비고','비고'], ref : 'BIZ_REGNO', width : '100px',style : 'text-align:center', type : 'output'},
        ];
