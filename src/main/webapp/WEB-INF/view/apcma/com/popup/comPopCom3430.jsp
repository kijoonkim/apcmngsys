...
function compopcom3430(options) {
    ...
    gfnma_setComSelect(['com3430Grid','CS_GROUP'], 				jsonCsGroup, 'L_COM011', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', '');
    gfnma_setComSelect(['com3430Grid','TAX_TYPE'], 				jsonTaxType, 'L_COM029', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', '');
    gfnma_setComSelect(['com3430Grid','COM_TYPE'], 				jsonComType, 'L_COM030', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', '');
    gfnma_setComSelect(['com3430Grid','BIZ_TYPE'], 				jsonBizType, 'L_HRA014', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', '');
    gfnma_setComSelect(['com3430Grid','DEFER_REASON'], 			jsonDeferReason, 'L_COM042', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', '');
    gfnma_setComSelect(['com3430Grid','TXN_STOP_REASON'], 		jsonTxnStopReason, 'L_COM048', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', '');
    gfnma_setComSelect(['com3430Grid','PUR_HANDOV_CNDT_CD'],	jsonPurHandovCndtCd, 'L_COM038_1', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', '');
    gfnma_setComSelect(['com3430Grid','PAY_DATE_RULE'], 		jsonPayDateRule, 'L_COM011', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', '');
    gfnma_setComSelect(['com3430Grid','DELIVERY_TYPE'], 		jsonDeliveryType, 'L_COM038_1', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', '');
    gfnma_setComSelect(['com3430Grid','RECEIPT_DATE_RULE'], 	jsonReceiptDateRule, 'L_COM039_1', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', '');
    gfnma_setComSelect(['com3430Grid','SHIPPING_TYPE'], 		jsonShippingType, 'L_COM039_1', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'SBSD_CD', 'CD_NM', 'Y', '');
    gfnma_setComSelect(['com3430Grid','WITHHOLD_TAX_OFFICE'], 	jsonWithholdaTaxOffice, 'L_CS_GOVERNMENT', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'CNPT_CD', 'CNPT_NM', 'Y', '');
    gfnma_setComSelect(['com3430Grid','WITHHOLD_TAX_OFFICE2'], 	jsonWithholdaTaxOffice2, 'L_CS_GOVERNMENT', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'CNPT_CD', 'CNPT_NM', 'Y', '');
    gfnma_setComSelect(['com3430Grid','WITHHOLD_TAX_TYPE'], 	jsonWithholdaTaxType, 'L_WITHHOLD_TAX_TYPE', '', gv_ma_selectedCorpCd, gv_ma_selectedClntCd, 'TX_TYPE_CD', 'TX_TYPE_NM', 'Y', '');
		...
		try {
  			if (_.isEqual("S", data.resultStatus)) {
  	        	...
  	        	data.cv_1.forEach((item, index) => {
  					const msg = {
  							CHANGE_TIME					: gfnma_nvl(item.CHG_DT),			
