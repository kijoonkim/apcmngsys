...
function compopcom3420(options) {
    ...
    gfnma_setComSelect(['com3420Grid','CS_GROUP'], jsonCsGroup, 'L_COM011', '', gv_ma_selectedApcCd, gv_ma_selectedClntCd, 'SUB_CODE', 'CODE_NAME', 'Y', '');
    gfnma_setComSelect(['com3420Grid','TAX_TYPE'], jsonTaxType, 'L_COM029', '', gv_ma_selectedApcCd, gv_ma_selectedClntCd, 'SUB_CODE', 'CODE_NAME', 'Y', '');
    gfnma_setComSelect(['com3420Grid','COM_TYPE'], jsonComType, 'L_COM030', '', gv_ma_selectedApcCd, gv_ma_selectedClntCd, 'SUB_CODE', 'CODE_NAME', 'Y', '');
    gfnma_setComSelect(['com3420Grid','BIZ_TYPE'], jsonBizType, 'L_HRA014', '', gv_ma_selectedApcCd, gv_ma_selectedClntCd, 'SUB_CODE', 'CODE_NAME', 'Y', '');
    gfnma_setComSelect(['com3420Grid','DEFER_REASON'], jsonDeferReason, 'L_COM042', '', gv_ma_selectedApcCd, gv_ma_selectedClntCd, 'SUB_CODE', 'CODE_NAME', 'Y', '');
    gfnma_setComSelect(['com3420Grid','TXN_STOP_REASON'], jsonTxnStopReason, 'L_COM048', '', gv_ma_selectedApcCd, gv_ma_selectedClntCd, 'SUB_CODE', 'CODE_NAME', 'Y', '');
    gfnma_setComSelect(['com3420Grid','PUR_HANDOV_CNDT_CD'], jsonPurHandovCndtCd, 'L_COM038_1', '', gv_ma_selectedApcCd, gv_ma_selectedClntCd, 'SUB_CODE', 'CODE_NAME', 'Y', '');
    gfnma_setComSelect(['com3420Grid','PAY_DATE_RULE'], jsonPayDateRule, 'L_COM011', '', gv_ma_selectedApcCd, gv_ma_selectedClntCd, 'SUB_CODE', 'CODE_NAME', 'Y', '');
    gfnma_setComSelect(['com3420Grid','DELIVERY_TYPE'], jsonDeliveryType, 'L_COM038_1', '', gv_ma_selectedApcCd, gv_ma_selectedClntCd, 'SUB_CODE', 'CODE_NAME', 'Y', '');
    gfnma_setComSelect(['com3420Grid','RECEIPT_DATE_RULE'], jsonReceiptDateRule, 'L_COM039_1', '', gv_ma_selectedApcCd, gv_ma_selectedClntCd, 'SUB_CODE', 'CODE_NAME', 'Y', '');
    gfnma_setComSelect(['com3420Grid','SHIPPING_TYPE'], jsonShippingType, 'L_COM039_1', '', gv_ma_selectedApcCd, gv_ma_selectedClntCd, 'SUB_CODE', 'CODE_NAME', 'Y', '');
    gfnma_setComSelect(['com3420Grid','WITHHOLD_TAX_OFFICE'], jsonWithholdaTaxOffice, 'L_CS_GOVERNMENT', '', gv_ma_selectedApcCd, gv_ma_selectedClntCd, 'CS_CODE', 'CS_NAME', 'Y', '');
    gfnma_setComSelect(['com3420Grid','WITHHOLD_TAX_OFFICE2'], jsonWithholdaTaxOffice2, 'L_CS_GOVERNMENT', '', gv_ma_selectedApcCd, gv_ma_selectedClntCd, 'CS_CODE', 'CS_NAME', 'Y', '');
    gfnma_setComSelect(['com3420Grid','WITHHOLD_TAX_TYPE'], jsonWithholdaTaxType, 'L_WITHHOLD_TAX_TYPE', '', gv_ma_selectedApcCd, gv_ma_selectedClntCd, 'TAX_TYPE_CODE', 'TAX_TYPE_NAME', 'Y', '');
