...
const CloudIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"></path></svg>
);

const CloudDrizzleIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-400"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"></path><path d="M8 19v1"></path><path d="M8 14v1"></path><path d="M16 19v1"></path><path d="M16 14v1"></path><path d="M12 21v1"></path><path d="M12 16v1"></path></svg>
);


const BugIcon = ({ alertLevel }) => {
    const color = alertLevel === '경보' ? 'text-red-500' : alertLevel === '주의' ? 'text-yellow-500' : 'text-green-500';
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={color}><path d="M14 12a2 2 0 1 0-4 0"></path><path d="M6.2 13.8a2.5 2.5 0 0 0 4.3 2.5"></path><path d="M13.5 16.3a2.5 2.5 0 0 0 4.3-2.5"></path><path d="M18 12h.01"></path><path d="M6 12h.01"></path><path d="M12 18v.01"></path><path d="M12 6V6"></path><path d="M7.5 18.5a4 4 0 1 0-5-5"></path><path d="M16.5 3.5a4 4 0 1 0 5 5"></path></svg>
    );
};

const CalendarIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect width="18" height="18" x="3" y="4" rx="2"></rect><path d="M3 10h18"></path></svg>
);

const LeafIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-green-600"><path d="M11 20A7 7 0 0 1 4 13V8a5 5 0 0 1 10 0v5a7 7 0 0 1-7 7m0 0v-5"></path></svg>
);

const BoxIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-500"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><path d="m3.29 7 8.71 5 8.71-5"></path><path d="M12 22V12"></path></svg>
);
    ...
    <div className="p-4 bg-white rounded-xl shadow-md col-span-1 lg:col-span-2 h-full">
        ...
        <div className="w-full h-64">
            <svg width="100%" height="100%" viewBox="0 0 500 200" preserveAspectRatio="none">
                ...
                {/* Points */}
                {[
                    [50, 130], [120, 90], [190, 110], [260, 60], [330, 80], [400, 50], [470, 70]
                ].map(([x, y], i) => (
                ...
                {['4월', '5월', '6월', '7월', '8월', '9월', '10월'].map((month, i) => (
                    <text key={month} x={50 + i * 70} y="180" fontSize="12" fill="#6b7280" textAnchor="middle">{month}</text>
                ))}
                <text x="15" y="45" fontSize="12" fill="#6b7280" textAnchor="end">10k</text>
                <text x="15" y="85" fontSize="12" fill="#6b7280" textAnchor="end">5k</text>
                <text x="15" y="125" fontSize="12" fill="#6b7280" textAnchor="end">1k</text>
            </svg>
        </div>
    </div>
);
        ...
        <div>
            ...
            {viewType === 'card' ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {apcData.map(apc => <APCCard key={apc.id} apc={apc} />)}
                </div>
            ) : (
                <div className="bg-white rounded-xl shadow-md overflow-hidden">
                    <table className="w-full text-left text-sm">
                        ...
                        <tbody>
                        {apcData.map(apc => <APCListItem key={apc.id} apc={apc} />)}
                        </tbody>
                    </table>
                </div>
            )}
    ...
    return (
        <div className="bg-slate-50 min-h-screen font-sans p-4 sm:p-6 lg:p-8">
            <div className="max-w-screen-xl mx-auto">
                ...
                {/* 탭 컨텐츠 */}
                <main>
                    {activeTab === 'apcList' ? <APCListView /> : <KPIView />}
                </main>
            </div>
        </div>
    );
